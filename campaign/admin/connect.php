...
if (DEVVERSION)
  ...
  $v = VERSION;
if (REGISTER) {
  $PoweredByImage = '<p class="poweredby"><a href="http://www.phplist.com/poweredby?utm_source=pl'.$v.'&amp;utm_medium=poweredhostedimg&amp;utm_campaign=phpList" title="visit the phpList website" ><img src="http://'.PHPLIST_POWEREDBY_URLROOT.'/ovex.jpg" width="70" height="30" title="powered by OVEX TECH '.$v.', &copy; OVEX TECH ltd" alt="powered by OVEX TECH '.$v.', &copy; OVEX TECH ltd" border="0" /></a></p>';
} else {
