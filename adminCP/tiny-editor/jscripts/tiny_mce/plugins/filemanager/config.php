<?php
        ...
        $mcFileManagerConfig['filesystem.path'] = '../../../../../../upload-media/'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = '../../../../../../upload-media/'; // absolute or relative from this script path.
