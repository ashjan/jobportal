<?php
        ...
        $mcImageManagerConfig['filesystem.path'] = '../../../../../../upload-media/'; // absolute or relative from this script path, optional.
       //  $mcImageManagerConfig['filesystem.path'] = '\\\200.200.200.4\\dev\\montenegro\\upload-media\\'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = '../../../../../../upload-media/'; // absolute or relative from this script path, required.
        //$mcImageManagerConfig['filesystem.rootpath'] = '\\\200.200.200.4\\dev\\montenegro\\upload-media\\'; // absolute or relative from this script path, required.
        ...
        $mcImageManagerConfig['filemanager.urlprefix'] = "../../../imagemanager/?type=fm"; // need to add "filemanager" button to tools as well.
