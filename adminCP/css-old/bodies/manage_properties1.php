...
$qry_prop = "SELECT ".$tblprefix."property_category.property_category_name,
					...
					Inner Join ".$tblprefix."property_manager ON ".$tblprefix."properties.pm_id = ".$tblprefix."property_manager.id
					$module_pm_where
					";
...
$totalPages = ceil($totalRows/$maxRows);
 $qry_limit = "SELECT ".$tblprefix."property_category.property_category_name,
					...
					Inner Join ".$tblprefix."property_category ON ".$tblprefix."properties.property_category = ".$tblprefix."property_category.id
					Left Join ".$tblprefix."property_accommodation ON ".$tblprefix."properties.business_type = ".$tblprefix."property_accommodation.id 
					Inner Join ".$tblprefix."property_manager ON ".$tblprefix."properties.pm_id = ".$tblprefix."property_manager.id					$module_pm_where
...
$qry_sub_type = "SELECT * FROM ".$tblprefix."business_subtype" ;
	...
	<tr>
			 ...
			 while(!$rs_accommodation->EOF){?>
				...
				<?php 
				 ...
				 ?>
					<!--
					<option value="
					<?php // echo $rs_accommodation->fields['id']; ?>">
					<?php // echo $rs_accommodation->fields['accomm_name'];?>
					</option>
					 -->
		...
		<tr>
	        <td style="border-left:1px solid #999999; border-bottom:1px solid #999999;">
  			Business Sub Type<br/>[Podvrsta objekta]</td>
		...
		<tr><td height="1px;"></td></tr>		
	     <tr>
		<td colspan="2" style="font-weight:bold; text-align:left; border:1px solid #999999; border-bottom:none;">Property Details<br/>[Detalji o objektu]</td></tr>
		 <tr>
	        <td style="border-left:1px solid #999999;">
  			Property Name
		   	</td>
...
?>
		...
		<tr>
			...
			<input type="text" name="no_property_rooms" id="no_property_roomss" class="field2" maxlength="4"  size="10" 
				value="<?php echo $_SESSION["addproperty"]["no_property_rooms"];?>"/> Rooms
			</td>
        </tr>
		<tr>
	        <td>
...
<td colspan="2" style="font-weight:bold; text-align:left; border:1px solid #999999; border-bottom:none;">Location<br/>[lokacija]</td>
		...
		<tr>
			...
			if(in_array(
			$rs_lang->fields['id'],$_SESSION['addproperty']['contact_language'])){echo "checked=checked";}}?> /> <?php echo $rs_lang->fields['Lan_name'];?><br />
			<?php
			 $rs_lang->MoveNext();
					}
					}
		...
		<tr><td height="1px;"></td></tr>		
		<tr>
		<td colspan="2" style="font-weight:bold; text-align:left; border:1px solid #999999; border-bottom:none;">Description</td>
		</tr>
		<tr>
		<td  style="border-left:1px solid #999999; border-bottom:1px solid #999999;" >
		...
		<td  style="border-right:1px solid #999999; border-bottom:1px solid #999999;">
		<textarea rows="8" cols="45" name="short_description" id="short_description" class="smalltxtareas"><?php echo $_SESSION["addproperty"]["short_description"];?></textarea>
		</td>
		</tr>
...
?>					</td>
		...
		<td  style="border-right:1px solid #999999; border-bottom:1px solid #999999;">
		<select name="propertystatus" id="propertystatus" class="fields">
		...
		<input type="hidden" value="0" name="propertystatus" id="propertystatus" />
		<tr>
	        <td colspan="2" style="border-left:1px solid #999999; border-right:1px solid #999999; border-bottom:1px solid #999999;">
  			
			<input type="checkbox" name="trmcond1" class="fields"  id="trmcond1" value="term" <?php if($_SESSION["addproperty"]["trmcond"]=='term')
			{echo "checked=\"checked\"";}?>/>
			I agree to the <a href="#">Terms and Conditions</a> of property.
		...
		<tr>
			...
			<td>
			<input style="margin:5px; width:176px; float:none; text-align:center;" type="submit" name="submit" id="submit"  value="Insert Property &nbsp;[Dodaj Vlasnik]" class="button" />
			</td>
        </tr>

		</table>
			<input type="hidden" name="act" value="manage_properties1" />
			<input type="hidden" name="request_page" value="properties_management1" />
...
<?php if($_SESSION[SESSNAME]['pm_moduleid']!=2){ ?>	
      <select name="pm_id" class="fields" id="pm_id" onchange="get_prop_name24('property_id1', this.value, '<?php echo MYSURL."ajaxresponse/get_prop_name24.php"?>')">
				 	<option value="0">Izaberite vlasnika objekta</option>
					<?php
					if(isset($_GET['pm_id'])){
...
<?php } ?>	
  ...
  <tr>
	...
	<tr>
			...
			?>
				<tr>
					<td colspan="14" class="errmsg"> Nije pronađen nijedan podatak</td>
				</tr>
			<?php
				}// end if($totalcount > 0)
			?>
