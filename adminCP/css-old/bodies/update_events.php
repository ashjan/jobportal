...
/*$qry_limit = "SELECT
 ...
 $qry_limit = "SELECT * FROM  ".$tblprefix."event_categories WHERE id =".$id;
...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="txt">
 	<tr>
  		<td id="heading">Update Events Category</td>
 	</tr>
	<tr>
		<td>
...
<table cellpadding="1" cellspacing="1" border="0" >				
			...
			<?php	}else{ ?>
				...
				<input name="event_category_name" id="event_category_name" value="<?php echo $rs_limit->fields['event_category_name']?>" type="text" size="55"  maxlength="30" />*
				<?php } ?>
				</td>
				</tr>
</table>				
...
<div class="border_div_categories"  align="center">				
		<table cellpadding="1" cellspacing="1" border="0" >
		<tr>
		<td><input style="margin:5px; width:150px; float:none; text-align:center;" name="addsubscribeSbt" id="addsubscribeSbt" type="submit" value="Update Event Category" class="button" />
		</td>
		</tr>
		</table>
</div>
<tr>
		...
		<input type="hidden" name="act" value="update_events">
