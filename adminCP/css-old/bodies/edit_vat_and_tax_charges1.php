	...
	<tr>
		<td>
            ...
            <?php } else {?>
             ...
             <td>PM Name</td>
              <td>
			    <select name="first_name" id="first_name" onchange="get_prop_name('property_name', this.value, '<?php echo MYSURL."ajaxresponse/get_prop_name_0.php"?>')"  class="fields">
		...
		<select name="property_name" id="property_name" class="fields" onchange="get_prp_vat_edit('room_type', this.value, '<?php echo MYSURL."ajaxresponse/get_prp_vat_edit.php"?>')" >
...
<option <?php echo $sel; ?> value="<?php echo $rs_prop->fields['id'];?>"><?php echo $rs_prop->fields['property_name'];  ?></option>
             ...
             <td>Property Name</td>
			  ...
			  <div id="property_name"> 
			    <select name="property_name" id="property_name" class="fields" />
					<option value="<?php echo $rs_property_sel->fields['id']; ?>"><?php echo $rs_property_sel->fields['property_name']; ?></option>
        ...
        <!--<input style="margin:5px; width:146px; float:none; text-align:center;" type="submit" name="submit" id="submit" value="Update Vat and Charges" class="button"  />-->
        
		<a href="javascript:" style="margin:5px; width:112px; float:none; text-align:center;" name="submit" id="submit" class="button" onclick="edit_vat_tax1()">Update Vat and Tax &nbsp;[A&#382;uriraj Podešavanja za PDV i takse]</a></td>
        </tr>
