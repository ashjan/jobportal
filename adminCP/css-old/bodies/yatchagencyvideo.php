...
<table width="100%" border="0" cellspacing="2" cellpadding="2" class="txt">
	<tr>
    	<td id="heading">Manage Yatch Agency Videos</td>
  	</tr>
    <tr>
			...
			?>
					<tr <?php if($i%2==0){ ?> bgcolor="#E7DAE7"  <?php }else{ echo 'bgcolor="#FFFFFF"'; }?>>
                        ...
                        <td valign="middle"><?php echo $rs_limit->fields['first_name']; ?></td>
						 <td valign="middle"><?php echo $rs_limit->fields['yatch_name']; ?></td>
						<td valign="middle">
...
<!--<video height="100" src="<?php //echo $rs_limit->fields['fileurl']; ?>" width="200" controls>
  <a href="/static/bunny.mp4">Download the video</a> for local playback.
						...
						<td valign="middle">
						<a href="admin.php?act=edit_yatchagncy_video&amp;id=<?php echo base64_encode($rs_limit->fields['mf_id']);?>"  ><img src="<?php MYSURL?>graphics/edit.gif" border="0" title="Edit" /></a>&nbsp;&nbsp;
							<a href="admin.php?act=yatchagencyvideo&amp;mode=delete&amp;id=<?php echo base64_encode($rs_limit->fields['mf_id']); ?>&amp;request_page=mngyatchagncyvideo" onClick="return confirm('Are you sure you want to Delete?')"><img src="<?php MYSURL?>graphics/delete.gif" title="Delete" border="0" /></a>
                       </td>
					</tr>
			<?php 
						$rs_limit->MoveNext();
