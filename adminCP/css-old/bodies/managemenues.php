 ...
 <div id="controls" class="add_subscriber">
		...
		<form name="managemenuesfrm" id="managemenuesfrm" action="admin.php" method="post" onSubmit="return validate_managemenues()" enctype="multipart/form-data">
			<table width="450" border="0" align="center" cellpadding="5" cellspacing="0" class="txt">
				<tr>
					<td class="fieldheading">Menu Title :(English) </td>
					 <td >
					 <input width="300" size="40" name="menu_title" class="fields" id="menu_title" type="text"  />
					</td>
				</tr>
			...
			echo '<tr>
			<td class="txt1" >Menu Title :('.$rs_language->fields['Lan_name'].') </td>
			<td >
    ...
    <td>
		...
		<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="txt">
			...
			<tr class="tabheading">
				...
				<td width="30%">Menu Content</td>
				<!--<td width="15%">Parents</td>-->
				<td width="30">Menu Postition</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="3" class="txt">
  ...
  <tr>
    ...
    <img border="0" alt="Menu Management screen guide" title="Menu management screen guide" src="graphics/menu_management_sample_scre.gif">
