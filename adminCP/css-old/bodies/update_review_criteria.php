...
$qry_limit = "SELECT * FROM  ".$tblprefix."review_criteria WHERE id =".$id;
...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="txt">
	...
	<tr>
		<td>
	<form name="managecontentfrm" action="admin.php?act=manage_review_criteria" method="post" onsubmit="return validate_content()" enctype="multipart/form-data">
...
<tr>
		...
		<input type="hidden" name="act" value="update_review_criteria">
