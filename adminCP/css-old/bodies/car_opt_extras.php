...
$qry_faq = "SELECT * FROM ".$tblprefix."car_optional" ;
$rs_faq = $db->Execute($qry_faq);
$count_add =  $rs_faq->RecordCount();
$totalRows = $count_add;
$totalPages = ceil($totalRows/$maxRows);

$qry_limit = "SELECT * FROM ".$tblprefix."car_optional LIMIT $startRow,$maxRows"; 
...
<div class="border_div_categories"  align="center">				
		...
		<input type="hidden" name="act" value="car_opt_extras">
    ...
    <td>
		...
		?>
					<tr <?php if($i%2==0){ ?> bgcolor="#E7DAE7"  <?php }else{ echo 'bgcolor="#FFFFFF"'; }?>>
						...
						<td valign="top">
							<a href="admin.php?act=update_car_opt_extra&amp;id=<?php echo base64_encode($rs_limit->fields['ser_id']);?>"><img src="<?php MYSURL?>graphics/edit.gif" border="0" title="Edit" /></a>&nbsp;&nbsp;
							<a href="admin.php?act=car_opt_extras&amp;mode=del_xtra&amp;id=<?php echo base64_encode($rs_limit->fields['ser_id']); ?>&amp;request_page=car_optionlxtra_management" onClick="return confirm('Are you sure you want to Delete?')"><img src="<?php MYSURL?>graphics/delete.gif" title="Delete" border="0" /></a>
                       </td>
					</tr>
			<?php 
						$rs_limit->MoveNext();
