...
$startRow = $pageNum * $maxRows;
 ...
 $qry_faq = "SELECT * FROM ".$tblprefix."site_gdt" ; 
...
$site_gdt=$tblprefix."site_gdt";
$qry_limit ="SELECT * FROM ".$tblprefix."site_gdt ORDER BY id DESC LIMIT ".$startRow.",".$maxRows ; 
...
<table width="100%" border="0" cellspacing="2" cellpadding="2" class="txt">
  <tr>
    <td id="heading">Manage GDT &nbsp; &nbsp; [Upravljanje op�tim uslovima]</td>
  </tr>
  <tr>
      <td colspan="8" align="center" <?php if(!empty($_GET['okmsg'])){ echo 'class="okmsg"'; }else{ echo 'class="errmsg"';} ?> ><?php if(!empty($_GET['errmsg'])){ echo base64_decode($_GET['errmsg']).base64_decode($_GET['okmsg']);}?></td>
  </tr>
  <tr class="tabheading">
    	<td colspan="5" align="right">Total Number of GDT Found: <?php echo $totalcountalpha ?></td>
	</tr>
...
<input style="width:250px;" name="gdt_page_title" id="gdt_page_title" class="fields" type="text" value="<?php echo stripslashes($rs_content->fields['gdt_page_title']);?>" />					
            ...
            Description: <br/>[Opis]		
                ...
                <td >
                    <input style="width:250px;" name="gdt_description" id="gdt_description" class="fields" type="text" value="<?php if(!empty($rs_content->fields['gdt_description'])){ echo stripslashes($rs_content->fields['gdt_description']);}?>" />					
              </td>
            </tr>
...
?>					</td>
				...
				<input type="hidden" name="act" value="manage_gdt">
				<input type="hidden" name="request_page" value="gdt_management" />
	...
	<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="txt">
      ...
      <tr class="tabheading"> 
	    ...
	    <td width="10%">Sr#</td>
                ...
                <td width="40%">Descriptions<br/>[Opis]</td>
				...
				if($pageNum==0)
				   {
					...
					<tr <?php if($i%2==0){ ?> bgcolor="#E7DAE7"  <?php }else{ echo 'bgcolor="#FFFFFF"'; }?>>
					  ...
					  <td width="3%" valign="top"><?php echo stripslashes($rs_limit->fields['gdt_page_title']); ?></td>
                      ...
                      <td valign="top">
                <a href="admin.php?act=edit_gdt&pageid=<?php echo base64_encode($rs_limit->fields['id']);?>&dgt_flag=<?php echo $rs_limit->fields['gdt_flag'];?>"><img src="<?php MYSURL?>graphics/edit.gif" border="0"  title="Edit" /></a>&nbsp;&nbsp;				
				
				
				<a href="admin.php?act=manage_gdt&amp;mode=delete&amp;id=<?php echo base64_encode($rs_limit->fields['id']); ?>&amp;request_page=gdt_management" onClick="return confirm('Are you sure you want to Delete?')"><img src="<?php MYSURL?>graphics/delete.gif" title="Delete" border="0" /></a>
                
                <a href="javascript:;" onClick="showfulltext('<?php echo $rs_limit->fields['id']; ?>')"  >
