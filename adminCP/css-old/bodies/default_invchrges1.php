...
<table width="100%" border="0" cellspacing="2" cellpadding="2" class="txt">
	<tr>
    	<td id="heading">Default Invoice Charge</td>
  	</tr>
    <tr>
  ...
  <tr>
    <td>
		<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="txt">
			...
			<tr class="tabheading">
				<td width="40%">Sr#</td>
                <td width="50%">Default Invoice Charge</td>
		...
		?>
					<tr <?php if($i%2==0){ ?> bgcolor="#E7DAE7"  <?php }else{ echo 'bgcolor="#FFFFFF"'; }?>>
                        ...
                        <td valign="top"><?php echo $rs_limit->fields['invoice_defcharg']."€"; ?></td>						
						
						<td valign="top">
							<a href="admin.php?act=edit_invoicecharge1&amp;id=<?php echo base64_encode($rs_limit->fields['id']);?>"><img src="<?php MYSURL?>graphics/edit.gif" border="0" title="Edit" /></a>&nbsp;&nbsp;
