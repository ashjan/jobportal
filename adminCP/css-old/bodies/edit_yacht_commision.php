...
$qry_limit =  "SELECT pmc.*,pm.id as pm_idd,pm.first_name FROM `".$tblprefix."property_manager_commission` as pmc INNER JOIN tbl_property_manager as pm ON pm.id=pmc.pm_id";
