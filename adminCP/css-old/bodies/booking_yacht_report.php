...
$where= " WHERE ".$tblprefix."yatbooking.pickup<='".$sort_order."' AND ".$tblprefix."yatbooking.dropoff>='".$searchkeyword."'";
}
 ...
 $qry_state = "SELECT
					".$tblprefix."yatbooking.amount,
					".$tblprefix."yatbooking.dropoff,
					".$tblprefix."yatbooking.pickup,
					".$tblprefix."yatbooking.yacht_booking_number,
					".$tblprefix."yatbooking.yacht_id,
					".$tblprefix."yacht_commission.yatch_id,
					".$tblprefix."yacht_commission.commission,
					".$tblprefix."yatbooking.customer_id,
					".$tblprefix."customer.id,
					".$tblprefix."customer.customer_name,
					".$tblprefix."customer.customer_last_name
					FROM
					".$tblprefix."yatbooking
					Left Join ".$tblprefix."yacht_commission ON ".$tblprefix."yatbooking.yacht_id = ".$tblprefix."yacht_commission.yatch_id
					Left Join ".$tblprefix."customer ON ".$tblprefix."yatbooking.customer_id = ".$tblprefix."customer.id ".$where ; 
...
$qry_limit = "SELECT
					...
					".$tblprefix."yatbooking
					Left Join ".$tblprefix."yacht_commission ON ".$tblprefix."yatbooking.yacht_id = ".$tblprefix."yacht_commission.yatch_id
					Left Join ".$tblprefix."customer ON ".$tblprefix."yatbooking.customer_id = ".$tblprefix."customer.id ".$where." LIMIT $startRow,$maxRows"; 
...
<table width="100%" border="0" cellspacing="2" cellpadding="2" class="txt">
	<tr>
    	<td id="heading">Yacht  Statistic </td>
  	</tr>
    <tr>
    ...
    <!--........................................Search ........................................-->
	<tr><td>
	<form name="testform" action="admin.php?act=booking_yacht_report" method="post">
...
<!--..............................................End of Search .................................-->
 	...
 	<tr class="tabheading">
    	<td colspan="5" align="right">Total Yacht Statistics Found: <?php echo $totalcountalpha ?></td>
	</tr>
	...
	<input type="hidden" name="act" value="booking_yacht_report" />
	<input type="hidden" name="request_page" value="yacht_print" />
    ...
    <td>
		<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="txt">
			...
			<tr class="tabheading">
                ...
                <td width="9%">yacht Days<br/>[Trajanje]</td>
                <td width="7%">Commission % Commission %<br/>[Iznos ]</td>
		...
		?>
					<tr <?php if($i%2==0){ ?> bgcolor="#E7DAE7"  <?php }else{ echo 'bgcolor="#FFFFFF"'; }?>>
                        ...
                        <td valign="top"><?php echo $rs_limit->fields['yacht_booking_number']?></td>						
                        <td valign="top"><?php echo ucwords($rs_limit->fields['customer_name'])." ".ucwords($rs_limit->fields['customer_last_name']); ?></td>
                        <td valign="top"><?php echo ucwords($rs_limit->fields['customer_name'])." ".ucwords($rs_limit->fields['customer_last_name']); ?></td>											
                        <td valign="top"><?php echo date("F j Y",strtotime($rs_limit->fields['pickup'])); ?></td>											
                        <td valign="top"><?php echo date("F j Y",strtotime($rs_limit->fields['dropoff'])); ?></td>						
                        <td valign="top"><?php 
						$date1 = strtotime($rs_limit->fields['pickup']);
						$date2 = strtotime($rs_limit->fields['dropoff']);
                        ...
                        <td valign="top"><?php echo number_format($rs_limit->fields['amount'],2);
						$rent[]= $rs_limit->fields['amount'];
						 ?>&euro;</td>			
                        <td valign="top"><?php
						  $comm=(float)$rs_limit->fields['commission']/100;
						  $comm_amount=(float) ($comm*$rs_limit->fields['amount']);
						  
						  $final_amount=$comm_amount + $rs_limit->fields['amount'];
						  echo number_format($final_amount,2);
						  $final_amount_i[]= $final_amount;
						  
						?>&euro;</td>	
                        <td valign="top"><?php
						  echo number_format($comm_amount,2);
						  $comm_amount_i[]= $comm_amount;
						  //$comm_i[] = $comm;
						?>&euro;</td>		
                        <td valign="top"></td>						
			...
			?>
                    ...
                    <tr bgcolor="#E7DAE7">
						...
						<td><strong><?php echo number_format(array_sum($comm_amount_i),2);?>&euro;</strong></td>
						<td>&nbsp;</td>
                        <td>&nbsp;</td>
					</tr>
