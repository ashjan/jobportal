...
<table width="100%" border="0" cellspacing="2" cellpadding="2" class="table">
    ...
    <tr>
 	...
 	<tr class="tabheading">
    	<td colspan="5" align="right">Total Currencies Found: <?php echo $totalcountalpha ?></td>
	</tr>
	<tr class="tabheading">
 ...
 <div id="controls" class="add_subscriber">
	<form name="managecontentfrm" action="admin.php" method="post" onsubmit="return validate_contant()" enctype="multipart/form-data">
        ...
        <tr>
			...
			<td>
			  <select id="countryname" class="fields" onchange="get_currency_name('get_currency', this.value, 'http://sunnymontenegro.com/adminCP/ajaxresponse/get_currency_name.php')" name="countryname"> 
      ...
      <tr>
		...
		<div id="get_currency">
		  ...
		  <div style="float:left; width:182px;">		
			...
			<select name="curr_name" id="curr_name" class="fields">
...
echo "<option value=".$rs_currencies_data->fields['curr_name'].">".$rs_currencies_data->fields['curr_name'].'</option>';
			...
			<div style="float:left; width:250px;">	
			<select name="curr_isocode" id="curr_isocode" class="fields">
		...
		<tr>
			...
			<td>
			<input type="submit" name="submit" value="Insert Currency &nbsp; [Unesite Naziv]" class="button" />
			</td>
        </tr>
		...
		<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="txt">
			...
			?>
					<tr <?php if($i%2==0){ ?> bgcolor="#E7DAE7"  <?php }else{ echo 'bgcolor="#FFFFFF"'; }?>>
					  ...
					  <a href="admin.php?act=manage_currencies&amp;mode=change_default&amp;id=<?php echo base64_encode($rs_limit->fields['id']); ?>&amp;pageNum=<?php echo $_GET['pageNum']?>&amp;request_page=manage_currencies">
