...
//Total pagination
$qry_faq = "SELECT * FROM ".$tblprefix."property_manager WHERE user_type=4 ORDER BY ".$sortby." " ;
  ...
  <tr>
    <td >
		...
		<tr class="tabheading">
			  ...
			  <td colspan="7" align="right">Total Employers Found:<?php echo $totalcountalpha ?><br/>
			  </td>
		  </tr>
		<tr class="tabheading">
		  <td colspan="7" align="right">
			...
			<tr class="tabheading">
				<td width="5%">Sr#</td>
                <td width="15%"><img src="images/ascending.gif" title="ascending" /><a href="admin.php?act=manage_employer&amp;sortby=<?php echo "first_name"; ?>"><b style="color:#000">First Name;</b></a></td>
