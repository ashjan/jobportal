...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="txt">
	...
	<tr>
				...
				<tr>
						...
						<?php //$qry_pm = "SELECT first_name,last_name FROM ".$tblprefix."property_manager WHERE id=".$_SESSION['pm_id'];
						...
						<?php $qry_pm = "SELECT first_name,last_name FROM ".$tblprefix."property_manager WHERE id=".$rs_limit->fields['pm_id']; 
 							  $rs_pm = $db->Execute($qry_pm);
 						?>
