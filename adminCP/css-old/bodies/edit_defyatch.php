...
$qry_limit = "SELECT 
                   ...
                   FROM ".$tblprefix."yatchdef_commission WHERE id=".$id; 
...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="txt">
 	<tr>
  		<td id="heading">Edit Yatch Default Commission</td>
 	</tr>
 <tr>
...
<tr>
		...
		<input type="hidden" name="act" value="edit_defyatch">
		<input type="hidden" name="act2" value="yatchdefault_commission">
