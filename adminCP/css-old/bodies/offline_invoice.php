<?php
	...
	//Dropdown for parent
	$online_qry = "SELECT * FROM ".$tblprefix."property_manager WHERE id=".$rs_faq->fields['pm_id'];
...
<table width="100%" border="0" cellspacing="2" cellpadding="2" class="table">
  ...
  <td colspan="8" align="center" <?php if(!empty($_GET['okmsg'])){ echo 'class="okmsg"'; }else{ echo 'class="errmsg"';} ?> ><?php if(!empty($_GET['errmsg'])){ echo base64_decode($_GET['errmsg']).base64_decode($_GET['okmsg']);}?></td>
    ...
    <td>
        ...
        <?php                                 
        //Dropdown List    
         $online_qry = "SELECT ".$tblprefix."property_manager.*,".$tblprefix."properties.property_name ,".$tblprefix."properties.pm_type ,".$tblprefix."properties.property_category  
