...
$qry_limit = "SELECT amf.*,pm.first_name,agn.agn_name,suplr.supplier_name,amf.status,yat.yatch_name FROM `tbl_agncy_mediafiles` as amf,`tbl_supplier` as suplr,`tbl_yatch` as yat,`tbl_yatchagency` as agn, `tbl_property_manager` as pm WHERE amf.mf_id='".$id."' and amf.pm_id=pm.id and amf.agncy_id=agn.agn_id and amf.supplier_id=suplr.id and amf.car_yatch_id=yat.id and yat.supplier=suplr.id and amf.which_agency='0'";
