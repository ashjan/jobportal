...
<?php	}else{ ?> 
		  <tr>
			...
			<td>
			<select name="pm_id" class="fields"   id="pm_id" onchange="get_add_prop_name_0('property_id', this.value, '<?php echo MYSURL."ajaxresponse/get_add_prop_name_0.php"?>')">
...
<?php }else{ ?>  
	...
	<div id="room_ids">
        ...
        <?php }?>
        <!--Room upto here -->
           <tr><td>Bedding Type Name[Vrsta kreveta] <br/><br/> (Ruski) <br/><br/>(Crnogorski)</td>
		   <td><br/><br/><br/><br/>
   ...
   <tr>
    ...
    <td>       
        ...
        ?>
            ...
            <select name="pm_id" class="fields" id="pm_id" onchange="get_prop_bedding('property_id1', this.value, '<?php echo MYSURL."ajaxresponse/get_prop_bedding.php"?>')">
	...
	$qry_content = "SELECT * FROM  ".$tblprefix."properties WHERE pm_id=".$_SESSION[SESSNAME]['pm_id']." AND pm_type=1  
					AND ".$tblprefix."properties.property_category=24";
    ...
    <td width="70%" align="center">
    <div id="property_id1">		
        <select name="property_id" class="fields" id="property_id" onChange="get_prop_bedding_types('rooms_id1',this.value,<?php echo $_SESSION[SESSNAME]['pm_id'];?>, '<?php echo MYSURL."ajaxresponse/get_prop_bedding_types.php"?>')">
        <?php
        if($count_add<=0){?>
        <option value="0">Izaberite objekat</option>
        <?php
