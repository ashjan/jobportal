...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="txt">
	...
	<form name="managemenufrm" action="admin.php" method="post" onsubmit="return validate_contant()" enctype="multipart/form-data">
		...
		<tr>
			...
			<td>
			<a class="button" href="admin.php?act=manage_properties1&amp;mode=delete&amp;id=<?php echo $_REQUEST['id']; ?>&amp;request_page=properties_management1" onClick="return confirm('Are you sure you want to Delete?')">Delete Property</a>
