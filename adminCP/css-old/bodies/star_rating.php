...
$startRow = $pageNum * $maxRows;
 ...
 $qry_faq = "SELECT * FROM ".$tblprefix."star_rating" ; 
...
$star_rating=$tblprefix."star_rating";
$qry_limit ="SELECT * FROM ".$tblprefix."star_rating ORDER BY id DESC LIMIT ".$startRow.",".$maxRows ; 
...
<table width="100%" border="0" cellspacing="2" cellpadding="2" class="txt">
  ...
  <tr class="tabheading">
    	<td colspan="5" align="right">Total Number of Star Rating Found: <?php echo $totalcountalpha ?></td>
	</tr>
    ...
    <td colspan="6"> <div id="controls" class="add_subscriber">
        <form name="managecontentfrm" action="admin.php" method="post" onsubmit="return validate_contant()" enctype="multipart/form-data">
		 ...
		 <tr>
			...
			<td >
<input style="width:250px;" name="start_rating" id="start_rating" class="fields" type="text" value="<?php echo stripslashes($rs_content->fields['gdt_page_title']);?>" />					
          </td>
        </tr>
...
?>					</td>
				...
				<input type="hidden" name="act" value="star_rating">
				<input type="hidden" name="request_page" value="star_rating" />
				...
				if($pageNum==0)
				   {
					...
					<tr <?php if($i%2==0){ ?> bgcolor="#E7DAE7"  <?php }else{ echo 'bgcolor="#FFFFFF"'; }?>>
					  ...
					  <td width="3%" valign="top"><?php echo stripslashes($rs_limit->fields['start_rating']); ?></td>
                      ...
                      <td valign="top">
                <a href="admin.php?act=edit_rating&pageid=<?php echo base64_encode($rs_limit->fields['id']);?>&dgt_flag=<?php echo $rs_limit->fields['gdt_flag'];?>"><img src="<?php MYSURL?>graphics/edit.gif" border="0"  title="Edit" /></a>&nbsp;&nbsp;				
				
				
				<a href="admin.php?act=star_rating&amp;mode=delete&amp;id=<?php echo base64_encode($rs_limit->fields['id']); ?>&amp;request_page=star_rating" onClick="return confirm('Are you sure you want to Delete?')"><img src="<?php MYSURL?>graphics/delete.gif" title="Delete" border="0" /></a>
