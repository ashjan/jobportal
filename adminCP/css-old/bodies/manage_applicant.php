...
//Total pagination
$qry_faq = "SELECT * FROM ".$tblprefix."property_manager WHERE user_type=3 ORDER BY ".$sortby." " ;
    ...
    <td >
		...
		<tr class="tabheading">
		  <td colspan="7" align="right">
			...
			<tr class="tabheading">
				<td width="5%">Sr#</td>
                <td width="15%"><img src="images/ascending.gif" title="ascending" /><a href="admin.php?act=manage_applicant&amp;sortby=<?php echo "first_name"; ?>"><b style="color:#000">First Name;</b></a></td>
                <td width="15%"><img src="images/ascending.gif" title="ascending" /><a href="admin.php?act=manage_applicant&amp;sortby=<?php echo "last_name"; ?>"><b style="color:#000">Last Name;
                </b></a></td>
				<td width="20%">Email Address</td>
                <td width="20%"><img src="images/ascending.gif" title="ascending" /><a href="admin.php?act=manage_applicant&amp;sortby=<?php echo "town"; ?>"><b style="color:#000">Town<br/>&nbsp;&nbsp;&nbsp;&nbsp;
                </b></a></td>
