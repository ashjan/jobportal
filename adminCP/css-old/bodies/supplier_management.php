  ...
  <tr>
    <td>
		...
		<tr class="tabheading">
			  ...
			  <td colspan="3" align="right">Total Supplier Found: <?php echo $totalcountalpha ?></td>
		  </tr>
		  <tr class="tabheading">
      ...
      <td><select name="agency" class="fields"   id="agency">
          ...
          <?php
				...
				?>
							...
							<tr>
								<td>Supplier Name*</td>
								<td><input type="text" name="supplier_name" class="fields" id="supplier_name" value="<?php echo $rs_limit->fields['supplier_name']; ?>" />						</td>
							</tr>        
							
							<tr>
								<td>Supplier Details*</td>
								<td><input type="text" name="supplier_details" class="fields" id="supplier_details" value="<?php echo $rs_limit->fields['supplier_details']; ?>" />						</td>
							</tr> 
						
					<td>&nbsp;</td>
					<td>
					<input style="margin:5px; width:100px; float:none; text-align:center;" type="submit" name="submit" id="submit" value="Insert Supplier Details" class="button" />			</td>
				</tr>
			...
			<tr class="tabheading">
				...
				<td width="30%">Supplier Details</td>
				...
				if($pageNum==0)
				   {
					...
					<tr <?php if($i%2==0){ ?> bgcolor="#E7DAE7"  <?php }else{ echo 'bgcolor="#FFFFFF"'; }?>>
					  ...
					  ".$tblprefix."agency where agn_id=".$rs_limit->fields['agency_id']; 
					  ...
					  <td width="3%" valign="top"><?php echo stripslashes($rs_limit->fields['supplier_details']); ?></td>
						...
						<td >
						<a href="admin.php?act=edit_supplier&amp;id=<?php echo base64_encode($rs_limit->fields['id']);?>">							<img src="<?php MYSURL?>graphics/edit.gif" border="0"  title="Edit" /></a>&nbsp;&nbsp;				
				<a href="admin.php?act=supplier_management&amp;mode=delete&amp;id=<?php echo base64_encode($rs_limit->fields['id']); ?>&amp;request_page=manage_supplier" onClick="return confirm('Are you sure you want to Delete?')"><img src="<?php MYSURL?>graphics/delete.gif" title="Delete" border="0" /></a>
...
<tr>
			...
			?>
				<tr>
					<td colspan="13" class="errmsg"> No Supplier Found</td>
				</tr>
			<?php
				}// end if($totalcount > 0)
			?>
