...
$qry_prop = "SELECT ".$tblprefix."property_manager.first_name,
					...
					INNER Join ".$tblprefix."property_manager ON ".$tblprefix."property_comments.pm_id = ".$tblprefix."property_manager.id".$module_pm_where."";

$rs_prop = $db->Execute($qry_prop);
$count_add =  $rs_prop->RecordCount();
$totalRows = $count_add;
$totalPages = ceil($totalRows/$maxRows);
 $qry_limit = "SELECT ".$tblprefix."property_manager.first_name,
					".$tblprefix."property_manager.last_name,
					...
					INNER Join ".$tblprefix."properties ON ".$tblprefix."property_comments.property_id = ".$tblprefix."properties.id
					INNER Join ".$tblprefix."customer ON ".$tblprefix."property_comments.customer_id = ".$tblprefix."customer.id 
					INNER Join ".$tblprefix."property_manager ON ".$tblprefix."property_comments.pm_id = ".$tblprefix."property_manager.id
					$module_pm_where
