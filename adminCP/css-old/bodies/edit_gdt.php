...
$page = base64_decode($_GET['pageid']); 
		...
		$qry_content = "SELECT * FROM  ".$tblprefix."site_gdt WHERE id = '".$page."'"; 
...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="txt">
 	<tr>
  		<td id="heading">Manage GDT &nbsp; &nbsp; [Upravljanje opštim uslovima]</td>
 	</tr>
...
?>
					...
					<!--<tr>
						<td>GDT Flag:</td>
						<td>
                        	<select name="gdt_flag" id="gdt_flag" >
       
                            	<option value="1"<?php //if($rs_content->fields['gdt_flag']==1){?> selected="selected"<?php //}?>>On line</option>
                                <option value="0"<?php //if($rs_content->fields['gdt_flag']==0){?> selected="selected"<?php //}?>>Off line</option>
                            </select>
...
?>					</td>
				...
				<tr>
					...
					<td>
						...
						<input type="hidden" name="act2" value="edit_gdt">
