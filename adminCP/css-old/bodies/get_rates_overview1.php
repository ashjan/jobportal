...
?>	
		<div  style="background-color:#0066FF; color:#FFFFFF; font-weight:bold; width:100%;float:left;">
             	 Standard Rates Overview &nbsp; [Pregled osnovnih cijena]
		</div>
				<?php 
				$single_rate_price = '';
				$standard_rate_price ='';
					  ...
					  <?php 
						...
						foreach($days as $day){
							...
							$propertyroomid = $standard_room_id[$day][0];
								...
								switch ($remaining_rooms){
					    	case (0):?>
					    	<div  class="value_div"><img src="graphics/red.jpg" title="<?php echo $day.",Preostale sobe=".$remaining_rooms.",Cijena za jednu osobu=".$single_rate_array[$day][0].",Osnovna cijena=".$standard_rate_array[$day][0]." , find_room ".$find_room." , Cancelled = ".$cancelled." , TotalBookings = ".$total_booking; ?>" border="0"/></div>
					    <?php 
					    break;
					    	case ($remaining_rooms>0):?>
					    	<div  class="value_div"><img src="graphics/green.jpg" title="<?php echo $day.",Preostale sobe=".$remaining_rooms.",Cijena za jednu osobu=".$single_rate_array[$day][0].",Osnovna cijena=".$standard_rate_array[$day][0]." , find_room ".$find_room; ?>" border="0"/></div>
					    <?php 
					    break;
					    	default:
					    		echo "";
