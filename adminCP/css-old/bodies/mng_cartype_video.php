...
$qry_faq = "SELECT amf.mf_id,amf.fileurl,agn.agn_name,amf.status,yat.id,yat.car_type FROM `tbl_type_mediafiles` as amf,`tbl_car` as yat,`tbl_agency` as agn WHERE amf.agncy_id=agn.agn_id and amf.car_yatch_id=yat.id and amf.which_type='1' and amf.aflag='1'";
...
$qry_limit = "SELECT amf.mf_id,amf.fileurl,agn.agn_name,amf.status,yat.id,yat.car_type FROM `tbl_type_mediafiles` as amf,`tbl_car` as yat,`tbl_agency` as agn WHERE amf.agncy_id=agn.agn_id and amf.car_yatch_id=yat.id and amf.which_type='1' and amf.aflag='1'";
...
<table width="100%" border="0" cellspacing="2" cellpadding="2" class="txt">
	<tr>
    	<td id="heading">Manage Car Type Videos</td>
  	</tr>
    <tr>
...
<!--		<a   href="<?php //MYSURL?>admin.php?act=add_categories"   href="javascript:;" onClick="jQuery('#controls').slideToggle('fast'); return false"  ><img src="<?php //MYSURL?>graphics/add.png" border="0" title="Add Country" /></a>-->
 ...
 <div id="controls" class="add_subscriber">
	<form name="managecontentfrm" action="admin.php" method="post" onsubmit="return validate_contant()" enctype="multipart/form-data">
		...
		<td></td></tr>
		<tr><td></td>
		<td><input style="margin:5px; width:100px; float:none; text-align:center;" type="submit" name="submit" id="submit" value="Upload Videos" class="button" />
