...
$qry_prop = "SELECT id,property_name FROM ".$tblprefix."properties where id = ".$rs_limit->fields['property_id']." 
			AND pm_type=0
...
<tr>
    <td colspan="8" align="center" <?php if(isset ($_REQUEST['okmsg'])) {?> class="okmsg" <?php } else { ?> class="errmsg" <?php }?>>
...
<table cellpadding="1" cellspacing="1" border="0" >
        ...
        <?php if($_SESSION[SESSNAME]['pm_moduleid']==2){?>
            ...
            <?php } else {?>
		<tr>
				<td class="txt" width="35%">Select Property Manager::</td>
					<td width="65%">
					<select name="pm_id" class="fields" id="pm_id" onchange="get_prop_name_edit('property_name', this.value, '<?php echo MYSURL."ajaxresponse/get_prop_name_edit.php"?>')">
		...
		<tr>
			...
			echo 'style="display:none;"'; }else{echo 'style="display:block;"';} ?>>
                    <tr>
					<td style="width:253px;" class="txt">Children Age For Free of Charge When Using Baby Cots <br/>[Godine do kojih djeca borave besplatno ako koriste krevetac] </td>
		...
		<tr>
			<td style="width:264px;" class="txt">Maximum Extra Beds<br/>[Maksimalan broj dodatnih kreveta]</td>
			<td style="width:364px;" class="txt">
	  ...
	  <tr>
			       ...
			       <td style="width:264px;" class="txt">Children Age For Free of Charge When Using Existing Beds <br/>[Godine do kojih djeca borave besplatno ako koriste postojeći krevet(Godina)]</td>
                   <td style="width:364px;" class="txt">
 ...
 <table border="0" cellpadding="2" cellspacing="1" id="extra_beds" style=" <?php echo $display_beds; ?>">
			<td style="width:253px;"  class="txt">Extra Bed Charges<br/>[Cijena dodatnog kreveta]</td>
			<td  class="txt" style="width:364px;"  >
 <input type="text" name="extra_bed_charges" class="fields" id="extra_bed_charges" value="<?php echo $rs_limit->fields['extra_bed_charges']?>" /> &nbsp EUR 
			</td>
 </table>
 </td>
 </tr>
 ...
 <div id="children_age_beds">
		...
		<tr>
			<td style="width:257px;" class="txt">Meal Plan  <br/>[Obroci]</td>
			<td>
...
$query_mon ="SELECT * FROM `tbl_language_contents` WHERE `page_id` ='$id' AND language_id ='7' AND `fld_type` = 'policy_foods' AND `field_name`= 'food_beverage_mon'";
		...
		<tr>
	        <td class="txt">
  			Internet Available<br/>[Internet]
		   	</td>
			<td>
