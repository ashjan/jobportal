<?php 
// image media add
if($_POST['mode']=='add' && $_POST['act']=='yatchtypesimages' && $_POST['request_page']=='manageyatchtypeimages'){
$post=$_POST;
$error='';
...
if($_POST['mode']=='update' && $_POST['act']=='edityatchtypesimages' && $_POST['request_page']=='manageyatchtypeimages'){
...
if($_GET['mode']=='delete' && $_GET['act']=='yatchtypesimages' && $_GET['request_page']=='manageyatchtypeimages'){
