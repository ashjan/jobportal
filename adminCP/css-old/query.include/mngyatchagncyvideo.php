<?php 
if($_POST['mode']=='add' && $_POST['act']=='yatchagencyvideo' && $_POST['request_page']=='mngyatchagncyvideo'){
$post=$_POST;
$error='';
...
if($post['supplier_id']=="0"){
	$error.="Select Supplier!!<br>";
}
if($post['yatch_id']=="0"){
	$error.="Select Yatch!!<br>";
}
...
if($_POST['mode']=='update' && $_POST['act']=='yatchagencyvideo' && $_POST['request_page']=='mngyatchagncyvideo'){
...
exit;*/
 ...
 if($_GET['mode']=='delete' && $_GET['act']=='yatchagencyvideo' && $_GET['request_page']=='mngyatchagncyvideo'){
