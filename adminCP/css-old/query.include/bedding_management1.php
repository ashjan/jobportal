<?php	
if($_POST['mode']=='add' && $_POST['act']=='manage_bedding1' && $_POST['request_page']=='bedding_management1'){
...
if($_POST['mode']=='update' && $_POST['act']=='manage_bedding1' && $_POST['request_page']=='bedding_management1'){
...
if($post['extra_beds']==''){
   $error="Please Enter Extra Beds<br>";
}
...
if($error!=''){
			$msg=base64_encode($error);
			header("Location: admin.php?errmsg=$msg&act=edit_bedding1&id=".$_POST['id']);
}else{
							...
							$run_query_language  =  $db->Execute($insert_query_mon_lan);
								...
								header("Location: admin.php?okmsg=$okmsg&act=manage_bedding1&id=".base64_encode($_POST['id']));
								exit;
							}else{
								$okmsg = base64_encode("Unable to Room Facility Update in database.!");
								header("Location: admin.php?errmsg=$okmsg&act=edit_bedding1&id=".base64_encode($_POST['id']));
								exit;
							}
...
if($_GET['mode']=='delete' && $_GET['act']=='manage_bedding1' && $_GET['request_page']=='bedding_management1'){
