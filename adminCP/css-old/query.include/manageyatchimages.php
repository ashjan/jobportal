<?php 
// image media add
if($_POST['mode']=='add' && $_POST['act']=='yatchagencyimages' && $_POST['request_page']=='manageyatchimages')
{
...
if($_POST['mode']=='update' && $_POST['act']=='yatchagencyimages' && $_POST['request_page']=='manageyatchimages')
{
...
// image media delete
if($_GET['mode']=='delete' && $_GET['act']=='yatchagencyimages' && $_GET['request_page']=='manageyatchimages')
{
		...
		else
		{
					...
					header("Location: admin.php?okmsg=$okmsg&act=".$_GET['act2']);
					exit;			
