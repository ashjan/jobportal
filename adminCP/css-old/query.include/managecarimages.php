<?php 
// image media add
if($_POST['mode']=='add' && $_POST['act']=='manage_car_images' && $_POST['request_page']=='managecarimages'){
$post=$_POST;
$error='';
...
if($_POST['mode']=='update' && $_POST['act']=='manage_car_images' && $_POST['request_page']=='managecarimages'){
...
if($_GET['mode']=='delete' && $_GET['act']=='manage_car_images' && $_GET['request_page']=='managecarimages'){
