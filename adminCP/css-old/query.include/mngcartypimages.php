<?php 
// image media add
if($_POST['mode']=='add' && $_POST['act']=='mng_cartype_images' && $_POST['request_page']=='mngcartypimages'){
$post=$_POST;
$error='';
...
if($_POST['mode']=='update' && $_POST['act']=='mng_cartype_images' && $_POST['request_page']=='mngcartypimages'){
...
if($_GET['mode']=='delete' && $_GET['act']=='mng_cartype_images' && $_GET['request_page']=='mngcartypimages'){
