<?php
if($_POST['mode']=='add' && $_POST['act']=='car_free_services' && $_POST['request_page']=='car_freesrvc_management')
		...
		$slug=slugcreation($event_category_name);
			...
			if($event_category_name == ''){
				...
				exit;
					...
					$qry_already_event= "SELECT ".$tblprefix."car_free_srvices.ser_id 
					FROM
					".$tblprefix."car_free_srvices where free_service='".$event_category_name."' ";
			 	 ...
			 	 $sql_category= "INSERT INTO ".$tblprefix."car_free_srvices  
														SET
...
//---------Edit Category---------
	if($_POST['mode']=='update' && $_POST['act']=='update_car_freeservice' && $_POST['request_page']=='car_freesrvc_management'){
	    $event_category_name = addslashes(trim($_POST['event_category_name']));  
		//$pm_id = $_POST['pm_id'];
		 ...
		 $_SESSION['event_category_name']= $event_category_name; 
			...
			if($event_category_name == ''){
				...
				exit;
			    	 ...
			    	 $sql_category= "UPDATE ".$tblprefix."car_free_srvices 
														SET
														free_service = '".$event_category_name."' 
														WHERE
														ser_id=".$id;
...
if($_GET['mode']=='del_service' && $_GET['act']=='car_free_services' && $_GET['request_page']=='car_freesrvc_management'){
		$id=base64_decode($_GET['id']);
		  $del_qry = " DELETE FROM ".$tblprefix."car_free_srvices WHERE ser_id = ".$id;  
