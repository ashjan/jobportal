...
if($error!=''){
  ...
  $check_duplicate = "SELECT id FROM ".$tblprefix."property_manager_commission WHERE pm_id=".$first_name." AND pt_id=".$property_name." AND ((from_date='".$post_from_date."' AND to_date='".$post_to_date."')  
 OR
 ...
 from_date <= '".$post_from_date."' AND to_date >= '".$post_to_date."'
	              ...
	              $update_img_query = "INSERT ".$tblprefix."property_manager_commission 
									                                SET
																	pm_id = ".$first_name.",
																	pt_id = ".$property_name.",
...
$default_commission=$rs_comm->fields['default_commission_rate'];
	...
	$check_duplicate = "SELECT id FROM ".$tblprefix."property_manager_commission WHERE pm_id=".$first_name." AND pt_id=".$property_name." 
		          ...
		          exit;     	
						 ...
						 $update_img_query = "UPDATE ".$tblprefix."property_manager_commission 
							SET
							pm_id = ".$first_name.",
							pt_id = ".$property_name.",
							from_date ='".date("Y-m-d",strtotime($post['from_date']))."', 
...
if($_GET['mode']=='updatestatus' && isset($_GET['status'])){
		...
		if($oldstatus == '0'){
			...
			$update_qry = "UPDATE ".$tblprefix."property_manager_commission SET 
...
$id=base64_decode($_GET['id']); 
	...
	$sel_qry = "SELECT commission FROM ".$tblprefix."property_manager_commission WHERE id =".$id;
		$rs_select = $db->Execute($sel_qry);
		$del_qry = " DELETE FROM ".$tblprefix."property_manager_commission WHERE id =".$id;
