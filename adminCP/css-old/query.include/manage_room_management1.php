<?php	
if($_POST['mode']=='add' && $_POST['act']=='room_management1' && $_POST['request_page']=='manage_room_management1'){
$post=$_POST;
$error='';
...
if($post['number_resources_available']=='' or is_int('number_resources_available')=='false'){
	//$error="Please Select Number Of Rooms<br>";
	$error="Molimo odaberite broj soba<br>";
}


if($post['max_persons_per_resource']==''){
	//$error="Please Select  Number of Maximum Persons Per Resourse<br>";
	$error="Molimo odaberite Broj Maksimalno osoba po resursima<br>";
}
...
//Update Section
if($_POST['mode']=='update' && $_POST['act']=='edit_room_management1' && $_POST['request_page']=='manage_room_management1'){
$post=$_POST;
$error='';
...
if($error!=''){
			...
			header("Location: admin.php?okmsg=$msg&act=".$post['act']);
							...
							$run_query_language  =  $db->Execute($insert_query_mon_lan);
								...
								header("Location: admin.php?okmsg=$okmsg&act=room_management1&id=".base64_encode($_POST['id']));
								exit;
							}else{
...
if($_GET['mode']=='delete' && $_GET['act']=='room_management1' && $_GET['request_page']=='manage_room_management1'){
