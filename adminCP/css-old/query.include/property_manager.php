...
//---------Add Property Manager---------
	if(!empty($_POST)){
	if($_POST['mode']=='add' && $_POST['act']=='managepropertymanager' && $_POST['request_page']=='property_manager'){
...
//---------Edit Property Managers---------
        if(!empty($_POST)){
	if($_POST['mode']=='update' && $_POST['act']=='edit_property_manager' && $_POST['request_page']=='property_manager'){
		...
		if($first_name == ''){
				...
				header("Location: admin.php?act=edit_property_manager&errmsg=$errmsg");
				exit;
		}
...
if($_GET['mode']=='delpage' && $_GET['act']=='managepropertymanager' && $_GET['request_page']=='property_manager'){
...
if($_GET['mode']=='change_pmstatus' && $_GET['act']=='managepropertymanager' && $_GET['request_page']=='property_manager'){
		$id=base64_decode($_GET['id']);
...
if($_GET['mode']=='make_consultant' && $_GET['act']=='managepropertymanager' && $_GET['request_page']=='property_manager'){
		$id=base64_decode($_GET['id']);
		$status=$_GET['m_status'];
...
//---------Status Code---------		
if($_GET['mode']=='change_default' && $_GET['act']=='managepropertymanager' && $_GET['request_page']=='property_manager'){
