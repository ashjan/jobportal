<?php 
// image media add
if($_POST['mode']=='add' && $_POST['act']=='mng_cartype_video' && $_POST['request_page']=='mngcartypvideos'){
$post=$_POST;
$error='';
...
if($_POST['mode']=='update' && $_POST['act']=='mng_cartype_video' && $_POST['request_page']=='mngcartypvideos'){
...
if($_GET['mode']=='delete' && $_GET['act']=='mng_cartype_video' && $_GET['request_page']=='mngcartypvideos'){
