...
<table width="100%" border="0" cellspacing="2" cellpadding="2" class="txt">
	<tr>
    	<td id="heading">Upravljanje slikama</td>
  	</tr>
    <tr>
...
<!--<a   href="<?php //MYSURL?>admin.php?act=add_categories"   href="javascript:;" onClick="jQuery('#controls').slideToggle('fast'); return false"  ><img src="<?php //MYSURL?>graphics/add.png" border="0" title="Add Country" /></a>-->
 ...
 <div id="controls" class="add_subscriber" <?php echo $style_err;?>>
	...
	<?php } else {?>
	<div class="image_div_title">Vlasnik objekta</div>
	...
	<?php }?>
	<?php if($_SESSION[SESSNAME]['pm_moduleid']==2){?>
	<div class="image_div_title">Naziv objekta</div>
 ...
 <option value="<?php echo $rs_property_manag->fields['id']; ?>"><?php echo $rs_property_manag->fields['property_name']; ?></option>
	...
	<div class="clear"></div>
	<div class="image_div_title">Room/Property Type</div>
	<div class="image_div_title_text">
	 <div id="room_idd">
  ...
  <tr>
    <td>
		<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="txt">
            ...
            <tr>
				<td width="20%" class="txt2">Izaberite  vlasnika objekta</td>
				<td width="60%" align="center">
                <select name="pm_id" class="fields" id="pm_id" onchange="get_prop_video1('property_id1', this.value, '<?php echo MYSURL."ajaxresponse/get_prop_name_videos1.php"?>')">
					<option value="0">Izaberite vlasnika objekta/option>
				 	<?php
						while(!$rs_users->EOF){?>
            ...
            <tr>
				<td width="20%" class="txt2">Izaberite  objekat</td>
				<td width="60%" align="center">
                <div id="property_id1">
            ...
            <tr>
				<td width="20%" class="txt2">Izaberite  sobu</td>
				<td width="60%" align="center">
                <div id="rooms_id1">
