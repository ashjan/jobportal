...
if(isset($_GET['filterid']) and $_GET['filterid'] != '' ){
	$qry_limit = "SELECT *
				FROM ".$vpropertymanager." 
				WHERE user_type=".$_GET['filterid']." 
				ORDER BY ".$sortby." 
				LIMIT $startRow,$maxRows";
			 
	//var_dump($qry_limit); exit;
	}
...
<table width="100%" border="0" cellspacing="2" cellpadding="2" class="txt">
  ...
  <tr class="tabheading">
			  ...
			  <td colspan="2" align="right">Total Users Found:<?php echo $totalcountalpha ?><br/>
			  </td>
		  </tr>
		  <tr class="tabheading">
		  ...
		  <select name "filter" id="filter" onchange="get_users_type_filter('filter_results', this.value, '<?php echo SURL?>ajaxresponse/get_users_type_filter.php')">
          ...
          <td colspan="1">
          Status: <select name "status" id="status" onchange="get_user_status_filter('filter_results', this.value, '<?php echo SURL?>ajaxresponse/get_user_status_filter.php')">
		  <option value="">ALL</option>
