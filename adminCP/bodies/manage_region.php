...
$qry_faq = "SELECT * FROM ".$tblprefix."property_regions" ;
$rs_faq = $db->Execute($qry_faq);
$count_add =  $rs_faq->RecordCount();
$totalRows = $count_add;
$totalPages = ceil($totalRows/$maxRows);

$qry_limit = "SELECT * FROM ".$tblprefix."property_regions LIMIT $startRow,$maxRows"; 
...
<table width="100%" border="0" cellspacing="2" cellpadding="2" class="table">
    ...
    <tr>
 	...
 	<tr class="tabheading">
    	<td colspan="5" align="right">Total Profile Region Found: <?php echo $totalcountalpha ?></td>
	</tr>
	<tr class="tabheading">
...
<div class="border_div_categories"  align="center" >
    <table cellpadding="1" cellspacing="1" border="0" class="table" >				
				...
				<td>
				<input type="text" name="region_name" class="fields"  id="region_name" value=""  />
 				</td> 
				</tr>
</table>				
</div>
...
<div class="border_div_categories"  align="center">				
		...
		<tr>
		<td><input style="margin:5px; width:180px; float:none; text-align:center;" name="addsubscribeSbt" id="addsubscribeSbt" type="submit" value="Add Region" class="button" />
		</td>
		</tr>
		</table>
</div>
<tr>
		...
		<input type="hidden" name="act" value="manage_region">
    ...
    <td>
		...
		?>
					<tr <?php if($i%2==0){ ?> bgcolor="#E7DAE7"  <?php }else{ echo 'bgcolor="#FFFFFF"'; }?>>
                        ...
                        <td valign="top"><?php echo $rs_limit->fields['region_name']; ?></td>						
