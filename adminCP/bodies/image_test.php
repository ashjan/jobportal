...
<script>
<img src="<?php echo MYSURL ; ?>classes/phpthumb/phpThumb.php?src=<?php echo MYSURL."graphics/car_upload/".$rs_limit->fields['car_picture'];?>&w=100&h=80&zc=1" border="0" />
{
opacity:0.4;
filter:alpha(opacity=40); /* For IE8 and earlier */
}
<img src="<?php echo MYSURL ; ?>classes/phpthumb/phpThumb.php?src=<?php echo MYSURL."graphics/car_upload/".$rs_limit->fields['car_picture'];?>&w=100&h=80&zc=1" border="0" />:hover
{
opacity:1.0;
