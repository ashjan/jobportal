...
$qry_faq = "SELECT * FROM ".$tblprefix."cardef_commission" ;
$rs_faq = $db->Execute($qry_faq);
$count_add =  $rs_faq->RecordCount();
$totalRows = $count_add;
$totalPages = ceil($totalRows/$maxRows);

$qry_limit = "SELECT * FROM ".$tblprefix."cardef_commission LIMIT $startRow,$maxRows"; 
...
<tr>
		...
		<input type="hidden" name="act" value="cardefault_commission">
    ...
    <td>
		...
		?>
					<tr <?php if($i%2==0){ ?> bgcolor="#E7DAE7"  <?php }else{ echo 'bgcolor="#FFFFFF"'; }?>>
						...
						<td valign="top">
							<a href="admin.php?act=edit_defcar&amp;id=<?php echo base64_encode($rs_limit->fields['id']);?>"><img src="<?php MYSURL?>graphics/edit.gif" border="0" title="Edit" /></a>&nbsp;&nbsp;
