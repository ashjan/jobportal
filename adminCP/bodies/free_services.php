...
$qry_faq = "SELECT * FROM ".$tblprefix."yatch_free_srvices" ;
$rs_faq = $db->Execute($qry_faq);
$count_add =  $rs_faq->RecordCount();
$totalRows = $count_add;
$totalPages = ceil($totalRows/$maxRows);

$qry_limit = "SELECT * FROM ".$tblprefix."yatch_free_srvices LIMIT $startRow,$maxRows"; 
...
<table width="100%" border="0" cellspacing="2" cellpadding="2" class="txt">
	<tr>
    	<td id="heading">Manage Free Services for sunnymontenegro.com Customer</td>
  	</tr>
    <tr>
...
<div class="border_div_categories"  align="center">				
		...
		<input type="hidden" name="act" value="free_services">
    ...
    <td>
		...
		?>
					<tr <?php if($i%2==0){ ?> bgcolor="#E7DAE7"  <?php }else{ echo 'bgcolor="#FFFFFF"'; }?>>
						...
						<td valign="top">
							<a href="admin.php?act=update_freeservice&amp;id=<?php echo base64_encode($rs_limit->fields['ser_id']);?>"><img src="<?php MYSURL?>graphics/edit.gif" border="0" title="Edit" /></a>&nbsp;&nbsp;
							<a href="admin.php?act=free_services&amp;mode=del_service&amp;id=<?php echo base64_encode($rs_limit->fields['ser_id']); ?>&amp;request_page=freesrvc_management" onClick="return confirm('Are you sure you want to Delete?')"><img src="<?php MYSURL?>graphics/delete.gif" title="Delete" border="0" /></a>
                       </td>
					</tr>
			<?php 
						$rs_limit->MoveNext();
