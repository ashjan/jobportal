...
$qry_com = "SELECT pmc.*,pm.id as pm_idd,pm.first_name,pm.last_name FROM `".$tblprefix."car_commission` as pmc INNER JOIN tbl_users as pm ON pm.id=pmc.pm_id  $module_pm_where  "; 
...
$qry_limit = "SELECT pmc.*,pm.id as pm_idd ,pm.first_name,pm.last_name,pt.agn_name FROM `".$tblprefix."car_commission` as pmc INNER JOIN tbl_users as pm ON pm.id=pmc.pm_id INNER JOIN tbl_agency as pt ON pt.agn_id=pmc.pt_id $module_pm_where ";
