...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="txt">
	...
	<tr>
  		<td><h3><?php if(empty($rs_content->fields['guest_rating']))
						echo 'Add New ';
...
?>					</td>
				...
				<tr>
					<td>&nbsp;</td>
					<td>
						<input type="submit" name="contentSbt" id="contentSbt" value="<?php if($page=='send'){echo 'Insert Guest Rating';}else {echo 'Guest Rating Events'; }?> " />						
						<input type="hidden" name="act" value="guest_rating">
						<input type="hidden" name="act2" value="edit_grating">
