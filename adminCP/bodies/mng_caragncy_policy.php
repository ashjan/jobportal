...
$qry_policy = "SELECT pp.*,pm.id as pid,pm.first_name,pm.last_name,pr.agn_id as prid,pr.agn_name
			   FROM `".$tblprefix."caragncy_policy` as pp LEFT JOIN ".$tblprefix."agency as pr ON pr.agn_id=pp.agncy_id LEFT JOIN ".$tblprefix."users as pm ON pm.id=pp.pm_id $module_pm_where ";			
