  ...
  <tr>
	...
	<div id="controls" class="add_subscriber">
	    ...
	    <tr>
             <td>PM Name</td>
              <td>			   
				<select name="first_name" id="pm_name_id" class="fields" onchange="get_prop_name_facility('pm_name', this.value, '<?php echo MYSURL."ajaxresponse/get_prop_name_facility.php"?>')">
			...
			<tr>
             <td>Property Name</td>
              <td>
			  <div id="pm_name">  
			    <select name="pr_id" id="pr_id" class="fields" onchange="get_room_facility_offline('room_type', this.value, '<?php echo MYSURL."ajaxresponse/get_room_facility_offline.php"?>')" />
   ...
   <tr>
		<tr><td>Facility Category<<br />[Izaberite kategoriju sadr&#382;aja]</td>
			   <td><select class="fields" name="property_fac_category"  onchange="get_fac_name('facility_name', this.value, '<?php echo MYSURL."ajaxresponse/get_room_fac_name.php"?>')">
				<option value="">Izaberite sadr&#382;aji</option>
	...
	<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="txt">
	 ...
	 <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="txt">
			...
			<tr>
             <td>PM Name</td>
              <td>
			    <select name="first_name" id="first_name" class="fields" onchange="get_prop_name16('property_name1', this.value, '<?php echo MYSURL."ajaxresponse/get_prop_name17_17.php"?>')">
					<option value="0">Izaberite vlasnika objekta</option>
				 	<?php
			...
			?>
			<tr>
             <td>Property Name<br/>[Naziv objekta</td>
              <td>
