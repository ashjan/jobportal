    ...
    <table cellpadding="1" cellspacing="1" border="0" class="txt" >
		...
		<tr>
				<td>Select Property Manager::</td>
					<td>
					<select name="pm_id" class="fields"   id="pm_id" onchange="get_prop_name('property_id', this.value, '<?php echo MYSURL."ajaxresponse/get_prop_name28.php"?>')">
...
<select name="property_id" class="fields"   id="property_id">
	<option value="0">Izaberite objekat</option>
		<?php 
		$qry_property = "SELECT id,property_name FROM ".$tblprefix."properties WHERE pm_id=".$_SESSION[SESSNAME]['pm_id']." AND pm_type=0  AND 
...
<select name="property_id" class="fields"   id="property_id">
	...
	<td><br/><br/><br/><br/>
    <input type="text" name="room_type" class="fields" id="room_type" value="" /><br/><br/>    
   ...
   <tr><td>Number Resources Available<br/>[Broj raspolo&#382;ivih soba]</td>
			...
			<tr><td>Meter Square (Room Dimension)<br/>[Dimenzije sobe]</td>
  ...
  <form  name="mngcontentform" action="admin.php" method="post" onsubmit="return validate_contant()" enctype="multipart/form-data">
    ...
    <td>
            ...
            ?>
                ...
                <select name="pm_id" class="fields" id="pm_id" onchange="get_prop_room1('property_id1', this.value, '<?php echo MYSURL."ajaxresponse/get_prop_room_mang1.php"?>')">
					<option value="0">Izaberite vlasnika objekta</option>
				 	<?php
            ...
            <tr>
                ...
                <div id="property_id1">		
                    <select name="property_id" class="fields" id="property_id" onChange="get_room_manag1('rooms_id1', this.value,<?php echo $_SESSION[SESSNAME]['pm_id'];?>, '<?php echo MYSURL."ajaxresponse/get_rooms_manag1.php"?>')">
                    <?php
                    if($count_add<=0){?>
                    <option value="0">Izaberite objekat</option>
                    <?php
