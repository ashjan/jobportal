...
$qry_limit = "SELECT 
                   ...
                   FROM ".$tblprefix."default_commission WHERE id=".$id; 
...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="txt">
 	<tr>
  		<td id="heading">Default Commission&nbsp;[Minimalna provizija]</td>
 	</tr>
 <tr>
...
<table cellpadding="1" cellspacing="1" border="0" >				
				<tr>
				<td class="txt1">Default Commission<br/>[Minimalna provizija]</td>
				<td>
				<?php 
...
<div class="border_div_categories"  align="center">				
		<table cellpadding="1" cellspacing="1" border="0" >
		<tr>
		<td><input style="margin:5px; width:200px; float:none; text-align:center;" name="addsubscribeSbt" id="addsubscribeSbt" type="submit" value="Update Commission &nbsp;[uspješno provizija]" class="button" />
		</td>
		</tr>
		</table>
</div>
<tr>
		...
		<input type="hidden" name="act" value="edit_default_commission">
