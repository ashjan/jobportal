...
$qry_limit = "SELECT mi.*,pm.id as pid,pm.first_name,pr.agn_id as prid,pr.agn_name  FROM `tbl_mediaimages` as mi INNER JOIN tbl_agency as pr ON pr.agn_id=mi.property_id INNER JOIN tbl_users as pm ON pm.id=mi.pm_id where mi.id=".$id; 
