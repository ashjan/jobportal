...
$startRow = $pageNum * $maxRows;
 ...
 $qry_policy = "SELECT pp.*,pm.id as pid,pm.first_name,pm.last_name,pr.agn_id as prid,pr.agn_name,yat.yatch_name
			   FROM `".$tblprefix."yatagncy_policy` as pp LEFT JOIN ".$tblprefix."yatchagency as pr ON pr.agn_id=pp.agncy_id LEFT JOIN ".$tblprefix."yatch as yat ON yat.id=pp.yatmodel LEFT JOIN ".$tblprefix."users as pm ON pm.id=pp.pm_id $module_pm_where ";
...
$qry_pm = "SELECT id,first_name,last_name FROM ".$tblprefix."users" ;
