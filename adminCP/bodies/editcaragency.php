...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="txt">
 	<tr>
  		<td id="heading">Car Agency Management Section</td>
 	</tr>
	...
	<form name="managemenufrm" action="admin.php" method="post" onSubmit="return validate_contant()" enctype="multipart/form-data">
			...
			?>
					...
					if($rs_property_manag->fields['id'] == $rs_limit->fields['pm_id'])
					{
					 ...
					 ?>><?php echo $rs_property_manag->fields['first_name'] ;?> <?php echo '&nbsp;'; ?><?php echo $rs_property_manag->fields['last_name'] ;?>
					</option>
				...
				<tr>
					...
					<tr>
							...
							<tr>
								<td>No.of Cars*</td>
								<td>
								<input type="text" name="yatchnumbr" id="yatchnumbr" value="<?php echo $rs_limit->fields['number_of_cars']?>" class="fields" />
								</td>
							</tr> 
					...
					<tr>
								<td>Description</td>
								<td>
								<textarea name="descagn" id="descagn"><?php echo stripslashes($rs_limit->fields['agncy_description']); ?></textarea>
								</td>
							</tr> 
							...
							<tr>
								...
								<td><textarea name="trmcond" id="trmcond" class="smalltxtareas" rows="10" cols="25"><?php echo $rs_limit->fields['agncy_terms']; ?></textarea></td>
							</tr>
							<tr>
						<td>Agency Logo </td>
					...
					<tr>
								<td>Agency Type*</td>
								<td>
							<input name="agntype" type="radio" class="field_div" id="agntype"
							<?php
			...
			<input type="hidden" name="act" value="editcaragency" />
			<input type="hidden" name="act2" value="caragency"/>
			<input type="hidden" name="request_page" value="manangecaragency" />
