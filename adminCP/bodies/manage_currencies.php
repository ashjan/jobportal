...
$qry_currencies_data = "SELECT * FROM tbl_currencies_data cd
						WHERE cd.`id` NOT IN (SELECT c.id FROM tbl_currencies c )" ;
...
<table width="100%" border="0" cellspacing="2" cellpadding="2" class="table">
    ...
    <tr>
    	<td colspan="8" align="center" <?php if(!empty($_GET['okmsg'])){ echo 'class="okmsg"'; }else{ echo 'class="errmsg"';} ?> ><?php if(!empty($_GET['errmsg'])){ echo base64_decode($_GET['errmsg']); } elseif(!empty($_GET['okmsg'])){ echo base64_decode($_GET['okmsg']);} ?></td>
    </tr>
 	<tr class="tabheading">
	...
	<tr class="tabheading">
		...
		<a   href="javascript:void(o);" onClick="jQuery('#controls').slideToggle('fast'); return false"  >
 ...
 <div id="controls" class="add_subscriber" style="display:none;">
	<form name="managecontentfrm" action="admin.php" method="post" onsubmit="return validate_contant()" enctype="multipart/form-data">
        ...
        <tr>
			...
			<td >
			  <select id="countryname" class="fields" name="countryname" style="width:42%; margin-left: 30%;"> 
