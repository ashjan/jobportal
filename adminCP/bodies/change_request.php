...
//Dropdown for parent
$category_qry = "SELECT * FROM ".$tblprefix."users WHERE id=".$rs_faq->fields['pm_id'];
    ...
    <td colspan="2">
            ...
            <tr>
					...
					//Dropdown for parent
				     ...
				     $category_qry = "SELECT ".$tblprefix."users.*,".$tblprefix."properties.property_name FROM ".$tblprefix."users 
