...
/*$qry_faq = "SELECT amf.mf_id,amf.fileurl,pm.first_name,agn.agn_name,suplr.supplier_name,amf.status,yat.yatch_name FROM `tbl_type_mediafiles` as amf,`tbl_supplier` as suplr,`tbl_yatch` as yat,`tbl_yatchagency` as agn, `tbl_users` as pm WHERE amf.agncy_id=agn.agn_id and amf.pm_id=pm.id and amf.supplier_id=suplr.id and amf.car_yatch_id=yat.id and yat.agency=suplr.id and amf.which_type='1' and amf.aflag='1'";*/
 $qry_faq = "SELECT
