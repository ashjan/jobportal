...
<!--form validation through javascript ENDS--->
   <table width="100%" border="0" cellspacing="0" cellpadding="2" class="txt">
 	<tr>
  		<td id="heading">Edit Property Policy [Podešavanje politike objekta]</td>
 	</tr>
...
<table cellpadding="1" cellspacing="1" border="0" >
        ...
        <?php if($_SESSION[SESSNAME]['pm_moduleid']==2){?>
            ...
            <?php } else {?>
		<tr>
				<td class="txt">Select Property Manager:<br/>[Ime vlasnika objekta]</td>
					<td>
					<select name="pm_id" class="fields" id="pm_id" onchange="get_prop_name('property_name', this.value, '<?php echo MYSURL."ajaxresponse/get_prop_name.php"?>')">
				 	<option value="0">Ime vlasnika objekta</option>
					<?php
		...
		<tr>
			<td class="txt">Maximum Baby Cots<br/>[Maksimalno krevetaca]
			</td>
			<td>
		...
		<tr>
			...
			<table border="0" cellpadding="2" cellspacing="1" width="100%" id="baby_costs" <?php if($rs_limit->fields['maximum_baby_cots']!=1){
			echo 'style="display:none;"'; }else{echo 'style="display:block;"';} ?>>
                    <tr>
					<td style="width:251px;" class="txt">Children Age For Free of Charge When Using Baby Cots<br/>[Godine do kojih djeca borave besplatno ako koriste krevetac] </td>
                    <td style="width:360px;" class="txt">
                     <select name="children_age" class="fields"   id="children_age">
                               <?php for($i = 0;$i <=12; $i++){?>		
                               <?php if($i == $rs_limit->fields['children_age']){ ?>
	    ...
	    <tr>		
        <td style="width:255px;" class="txt">Children Age For Free of Charge When Using Existing Beds<br/>[Godine do kojih djeca borave besplatno ako koriste postojeći krevet(Godina)]</td>
		<td class="txt" style="width:440px;">
 ...
 <table border="0" cellpadding="2" cellspacing="1" id="extra_beds" style=" <?php echo $display_beds; ?>">
			<td style="width:254px;" class="txt">Extra Bed Charges<br/>[Cijena dodatnog kreveta]</td>
			<td class="txt">
 ...
 <div id="children_age_beds">
		<tr>
			<td colspan="2" class="txt">
			<table border="0" cellpadding="2" cellspacing="1" id="baby_costs" style="display:none;" >
                    <tr>
					<td   class="txt">Children Age For free of charge when using extra beds<br/>[Godine do kojih djeca borave besplatno ako koriste dodatni krevet (Godina] </td>
                    <td align="left" >
                 <select name="children_age_beds" class="fields" >
                           <?php for($i = 1;$i <=12; $i++){?>		
						   <?php if($i == $rs_limit->fields['children_age_beds']){ ?>
		...
		<tr>
		<td colspan="2"  style="text-align:left; font-weight:bold;" class="txt">Cancellation Policy<br/>[Otkazivanje politika]</td>
		</tr>
		<tr><td class="txt">Cancellation Days<br/>[Naknade otkaz posto]</td>
			<td>
			...
			(<?php echo $i;?>) Dan</option>
			<?php }?>
			
			</select>
			</td></tr>
		<tr><td class="txt">Cancellation Charges Percent<br/>[Naknade otkaz posto]</td>
			<td class="txt">
		<select name="cancellation_charges_percent" id="cancellation_charges_percent" class="fields">
		<option value="0">Cijena jednog noćenja će biti naplaćena</option>
		...
		%
			...
			<tr>
		<td colspan="2"  style="text-align:left; font-weight:bold;" class="txt">
			No Show Policy<br/>[Politika u slučaju nepojavljivanja]
			</td>
			</tr>
			
			
			<tr><td class="txt">No Show Policy<br/>[Politika u slučaju nepojavljivanja]</td>
			<td>
			<select name="no_show_policy" class="fields"   id="no_show_policy">
					
					<option <?php if($rs_limit->fields['no_show_policy']==1){ echo 'selected="selected"';} ?> value="1">Cijena jednog noćenja će biti naplaćena</option>
					<option value="0" <?php if($rs_limit->fields['no_show_policy']==0){ echo 'selected="selected"';} ?> >Ukupna cijena noćenja će biti naplaćena</option>
				 </select>
			</td></tr>
		...
		<tr>
			<td class="txt">Break Fast<br/>[Break]</td>
			<td>
		...
		<tr>
			<td class="txt">Meal Plan  <br/>[Obroci]</td>
			<td>
		...
		<tr>
		    <td  style="text-align:left; font-weight:bold;" class="txt">
  			Free services<br/>[Besplatne usluge]
		   	</td>
		   	<td class="txt">
		   	<?php
		...
		<tr>
			<td class="txt">Credit Card Accepted<br/>[Prihvaćamo kreditne kartice]</td>
	...
	?> checked="checked"<?php }?>/><!--Don't Accept Credit Card-->Ne prihvaćaju kreditne kartice<br/>
	...
	?> checked="checked"<?php }?>/><!--Maestro-->učitelj<br/> 		
		...
		<tr>
			<td class="txt">Pay Deposit<br/>[platiti depozit]</td>
			<td>
		...
		<tr>
	        <td class="txt">
  			Food & Beverage (Rus)<br/>[Hrana i piće (Ruski)]
		   	</td>
			<td>
<?php  
...
$query_mon ="SELECT * FROM `tbl_language_contents` WHERE `page_id` ='$id' AND language_id ='7' AND `fld_type` = 'policy_foods' AND `field_name`= 'food_beverage_mon'";
		...
		<tr>
			...
			<td>
			<select name="internet_available" id="internet_available" class="fields">
				<option
				<?php
        ...
        <tr>
			...
			<td>
<?php  
$query ="SELECT * FROM `tbl_language_contents` WHERE `page_id` ='$id' AND language_id ='5' AND `fld_type` = 'policy_internet_type' AND `field_name`= 'internet_type_rus'";
$result =mysql_fetch_object( mysql_query($query));	
?>            
			<input type="text" name="internet_type_rus" class="fields" id="internet_type_rus" value="<?php echo $result->translated_text;?>" />
			</td>
        </tr>
        ...
        <tr>
			...
			<td>
<?php  
$query ="SELECT * FROM `tbl_language_contents` WHERE `page_id` ='$id' AND language_id ='7' AND `fld_type` = 'policy_internet_type' AND `field_name`= 'internet_type_mon'";
$result =mysql_fetch_object( mysql_query($query));	
?>             
			<input type="text" name="internet_type_mon" class="fields" id="internet_type_mon" value="<?php echo $result->translated_text;?>" />
			</td>
        </tr>
		...
		<tr>
	        <td class="txt">
  			Internet Cost<br/>[Internet Troškovi]
		   	</td>
			<td>
        ...
        <tr>
			...
			<td>
<?php  
$query ="SELECT * FROM `tbl_language_contents` WHERE `page_id` ='$id' AND language_id ='5' AND `fld_type` = 'policy_internet_location' AND `field_name`= 'internet_location_rus'";
$result =mysql_fetch_object( mysql_query($query));	
?>            
			<input type="text" name="internet_location_rus" class="fields" id="internet_location_rus" value="<?php echo $result->translated_text;?>" />
			</td>
        </tr>
        ...
        <tr>
			...
			<td>
<?php  
$query ="SELECT * FROM `tbl_language_contents` WHERE `page_id` ='$id' AND language_id ='7' AND `fld_type` = 'policy_internet_location' AND `field_name`= 'internet_location_mon'";
$result =mysql_fetch_object( mysql_query($query));	
?>              
			<input type="text" name="internet_location_mon" class="fields" id="internet_location_mon" value="<?php echo $result->translated_text;?>" />
			</td>
        </tr>
        <tr>
   			<td>&nbsp;</td>
		...
		<tr>
	        <td class="txt">
  			Parking Place <br/>[parkirno mjesto]
		   	</td>
			<td>
        ...
        <tr>
			...
			<td>
<?php  
$query ="SELECT * FROM `tbl_language_contents` WHERE `page_id` ='$id' AND language_id ='5' AND `fld_type` = 'policy_parking_place' AND `field_name`= 'parking_place_rus'";
$result =mysql_fetch_object( mysql_query($query));	
?>
			<input type="text" name="parking_place_rus" class="fields" id="parking_place_rus" value="<?php echo $result->translated_text;?>" />
			</td>
        </tr>
		...
		<tr>
			...
			<td>
<?php  
$query ="SELECT * FROM `tbl_language_contents` WHERE `page_id` ='$id' AND language_id ='7' AND `fld_type` = 'policy_parking_place' AND `field_name`= 'parking_place_mon'";
$result =mysql_fetch_object( mysql_query($query));	
?>            
			<input type="text" name="parking_place_mon" class="fields" id="parking_place_mon" value="<?php echo $result->translated_text;?>" />
			</td>
        </tr>
		<tr>
   			<td>&nbsp;</td>
        ...
        <tr>
	        <td class="txt">
  			Parking Costs  <br/>[Lokacija parkinga]
		   	</td>
			<td>
...
<textarea name="important_notice" id="important_notice" rows="4" cols="28"><?php echo $rs_limit->fields['important_notice']?></textarea>
        ...
        <tr>
			...
			<td>
<?php  
$query ="SELECT * FROM `tbl_language_contents` WHERE `page_id` ='$id' AND language_id ='5' AND `fld_type` = 'policy_important_notice' AND `field_name`= 'important_notice_rus'";
$result =mysql_fetch_object( mysql_query($query));	
?>
			<textarea name="important_notice_rus"  id="important_notice_rus" rows="4" cols="28"><?php echo $result->translated_text;?></textarea>
			</td>
        </tr>
        ...
        <tr>
			...
			<td>
<?php  
$query ="SELECT * FROM `tbl_language_contents` WHERE `page_id` ='$id' AND language_id ='7' AND `fld_type` = 'policy_important_notice' AND `field_name`= 'important_notice_mon'";
$result =mysql_fetch_object( mysql_query($query));
?>
			<textarea name="important_notice_mon"  id="important_notice_mon" rows="4" cols="28"><?php echo $result->translated_text;?></textarea>
			</td>
        </tr>
...
<div class="border_div_categories" style=" background-color: #E7DAE7; float:left; width:100%;"  align="center">				
		...
		<tr>
		<td>
<input style="margin:5px; width:180px; float:none; text-align:center;" name="addsubscribeSbt" id="addsubscribeSbt" type="submit" value="Update Policy &nbsp;[A&#382;uriraj politika]" class="button"/>
		</td>
		</tr>
		</table>
</div>
