<?php
	...
	$qry_pm = "SELECT ".$tblprefix."users.*,".$tblprefix."properties.property_name ,".$tblprefix."properties.pm_type ,".$tblprefix."properties.property_category 
	...
	//Dropdown for parent
	$offline_qry = "SELECT * FROM ".$tblprefix."users WHERE id=".$rs_faq->fields['pm_id'];
