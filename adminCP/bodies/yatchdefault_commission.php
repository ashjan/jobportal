...
$qry_faq = "SELECT * FROM ".$tblprefix."yatchdef_commission" ;
$rs_faq = $db->Execute($qry_faq);
$count_add =  $rs_faq->RecordCount();
$totalRows = $count_add;
$totalPages = ceil($totalRows/$maxRows);

$qry_limit = "SELECT * FROM ".$tblprefix."yatchdef_commission LIMIT $startRow,$maxRows"; 
...
<tr>
		...
		<input type="hidden" name="act" value="yatchdefault_commission">
		<input type="hidden" name="act2" value="default_commission">
		<input type="hidden" name="id" value="<?php echo base64_encode($id); ?>">
		<input type="hidden" name="request_page" value="default_commission_yatch" />
					</td>
				</tr>
</form> 
    ...
    <td>
		...
		?>
					<tr <?php if($i%2==0){ ?> bgcolor="#E7DAE7"  <?php }else{ echo 'bgcolor="#FFFFFF"'; }?>>
						...
						<td valign="top">
							<a href="admin.php?act=edit_defyatch&amp;id=<?php echo base64_encode($rs_limit->fields['id']);?>"><img src="<?php MYSURL?>graphics/edit.gif" border="0" title="Edit" /></a>&nbsp;&nbsp;
