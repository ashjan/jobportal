...
$qry_pm2 = "SELECT id,first_name FROM ".$tblprefix."users where id = ".$rs_limit->fields['pm_id'] ;
...
<!--form validation through javascript ENDS--->
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="2" class="txt">
 	<tr>
  		<td id="heading">Edit Property Category</td>
 	</tr>
...
<table cellpadding="1" cellspacing="1" border="0" >
				...
				<?php }?>
				 ...
				 <tr>
					...
					<td>               
						...
						<?php 
						$qry_property = "SELECT id,property_name FROM ".$tblprefix."properties 
		...
		<tr>
			<td class="txt">Maksimalno krevetaca</td>
			<td>
		...
		<tr>
			...
			<table border="0" cellpadding="2" cellspacing="1" width="100%" id="baby_costs" style="display:none;" >
                    <tr>
					<td style="width:255px;" class="txt">Children Age For Free of Charge When Using Baby Cots </td>
	    ...
	    <tr>		
        <td style="width:255px;" class="txt">Children Age For Free of Charge When Using Existing Beds </td>
		<td>
 ...
 <table border="0" cellpadding="2" cellspacing="1" id="extra_beds" style=" <?php echo $display_beds; ?>">
			<td style="width:255px;" class="txt">Extra Bed Charges</td>
			<td class="txt">
 ...
 <div id="children_age_beds">
		...
		<td colspan="2"  style="text-align:left; font-weight:bold;" class="txt">
			...
			<select name="no_show_policy" class="fields"   id="no_show_policy">
					...
					<option value="0">Total Price of the Reservation will be Charged</option>
				 </select>
			</td></tr>
		...
		<tr>
			<td style="width:260px;" class="txt">Meal Plan</td>
			<td>
