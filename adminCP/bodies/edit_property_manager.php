...
$qry_limit = "SELECT * FROM ".$tblprefix."users WHERE id=".$id;
...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="txt">
 	<tr>
  		<td id="heading">Update Property Manager [A&#382;uriraj Vlasnik objekta]</td>
 	</tr>
	<tr>
  		<td></td>
	</tr>
	...
	<form name="managemenufrm" action="admin.php" method="post" onSubmit="return validate_contant()" enctype="multipart/form-data">
			...
			if(!empty($_SESSION['email_address'])){ ?> 
					...
					<tr>
						<td>Business Email<br/>Poslovni email </td>
						<td>
						<?php
			...
			if(!empty($_SESSION['password'])){ ?> 
                        ...
                        <td>
                            ...
                            [Pa&#382;nja: Ako ne &#382;elite da promijenite lozinku, ostavite polje prazno]
                        </td>
                        </tr>
			...
			<td>
			<input type="submit" class="button" name="submit" value="Update Details [A&#382;uriraj detalje]" />
            
			</td>
        </tr>
		</table>
			<input type="hidden" name="act" value="edit_users" />
			<input type="hidden" name="act2" value="managepropertymanager" />
			<input type="hidden" name="request_page" value="users" />
