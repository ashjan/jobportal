...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="txt">
 	<tr>
  		<td id="heading">Edit Yatch Inventory Image  Section</td>
 	</tr>
	<tr>
		<td>
...
<table cellpadding="1" cellspacing="1" border="0" >	
	<tr>
	<td class="txt1">Yatch Inventory Manager</td>
	<td>
...
<tr>
		...
		<input type="hidden" name="act" value="edityatchinventoryimages">
		<input type="hidden" name="act2" value="yatchinventoryimages">
