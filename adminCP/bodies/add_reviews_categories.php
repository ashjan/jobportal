...
$id=base64_decode($_GET['id']);
		$qry_content = "SELECT * FROM  ".$tblprefix."reviews_category WHERE id =".$id;
...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="txt">
	...
	<tr>
	<td>
	<form name="managecontentfrm" action="admin.php" method="post" onsubmit="return validate_contant()" 
