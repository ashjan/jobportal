...
$qry_faq = "SELECT * FROM ".$tblprefix."free_badge where id='1'" ;
$rs_faq = $db->Execute($qry_faq);
$count_add =  $rs_faq->RecordCount();
$totalRows = $count_add;
$totalPages = ceil($totalRows/$maxRows);

$qry_limit = "SELECT * FROM ".$tblprefix."free_badge where id='1'"; 
...
<div class="text-muted bootstrap-admin-box-title">
    Manage Free for SMNE Offer Badge Image
</div></div>
 ...
 <div id="controls" class="add_subscriber">
	<form name="managecontentfrm" action="admin.php" method="post" onsubmit="return validate_contant()" enctype="multipart/form-data">
		...
		<tr>
	        <td>&nbsp;</td>
			<td>
  <input style="margin:5px; width:186px; float:none; text-align:center;" type="submit" name="submit" id="submit" value="Update Image" class="button" />
			</td>
        </tr>
		</table>
			<input type="hidden" name="act" value="freeimage" />
			<input type="hidden" name="request_page" value="manage_freeimages" />
			<input type="hidden" name="mode" value="addbadgefree">
