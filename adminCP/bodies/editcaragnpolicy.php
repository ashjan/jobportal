...
$qry_policy = "SELECT pp.*,pm.id as pid,pm.first_name,pm.last_name,pr.agn_id as prid,pr.agn_name
			   FROM `".$tblprefix."caragncy_policy` as pp,".$tblprefix."agency as pr, ".$tblprefix."users as pm WHERE 	 	    		   pp.pol_id='".$id."' and pr.agn_id=pp.agncy_id and pm.id=pp.pm_id $module_pm_where ";
