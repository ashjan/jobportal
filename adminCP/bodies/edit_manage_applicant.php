...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="txt">
 	<tr>
  		<td id="heading">Update Applicant</td>
 	</tr>
	<tr>
  		<td></td>
	</tr>
	...
	<form name="managemenufrm" action="admin.php" method="post" onSubmit="return validate_contant()" enctype="multipart/form-data">
			...
			<input type="hidden" name="act" value="edit_manage_applicant" />
			<input type="hidden" name="act2" value="manage_applicant" />
			<input type="hidden" name="request_page" value="applicant_manager" />
