...
$qry_limit =  "SELECT * FROM ".$tblprefix."users_commission where id='".$id."'";
...
$rs_property_manag = $db->Execute($qry_property_manag);
	    ...
	    $qry_content = "SELECT pmc.*,pm.id as pm_idd ,pm.first_name,pm.last_name,pt.property_name FROM `".$tblprefix."users_commission` as pmc INNER JOIN tbl_users as pm ON pm.id=pmc.pm_id INNER JOIN tbl_properties as pt ON pt.id=pmc.pt_id WHERE pmc.id=".$id.$module_pm_where;
