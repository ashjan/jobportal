...
$page = base64_decode($_GET['pageid']); 
		...
		$qry_content = "SELECT * FROM  ".$tblprefix."star_rating WHERE id = '".$page."'"; 
...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="txt">
 	<tr>
  		<td id="heading">Star Rating Management Section</td>
 	</tr>
 
	<tr>
  		<td><h3><?php if(empty($rs_content->fields['start_rating']))
						echo 'Add New ';
...
<input style="width:250px;" name="start_rating" id="start_rating" class="fields" type="text" value="<?php echo stripslashes($rs_content->fields['start_rating']);?>" />					
...
?>					</td>
				...
				<tr>
					<td>&nbsp;</td>
					<td>
						<input type="submit" class="button" name="contentSbt" id="contentSbt" value="<?php if($page=='send'){echo 'Insert Star Ratin';}else {echo 'Star Ratin Events'; }?> " />						
						<input type="hidden" name="act" value="star_rating">
						<input type="hidden" name="act2" value="edit_rating">
