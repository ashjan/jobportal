...
$id=base64_decode($_GET['id']);
		$qry_content = "SELECT * FROM  ".$tblprefix."users WHERE id =".$id;
		$rs_content = $db->Execute($qry_content);

}
$sql_property = "select * from ".$tblprefix."users where parent_id = 0";
...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="txt">
	...
	<td>
								...
								?>    
										...
										<input type="hidden" name="act2" value="add_users.php">
