...
".$tblprefix."users as pm ON pm.id=tof.pmid LEFT JOIN  ".$tblprefix."properties as pr ON pr.id=tof.property_id LEFT JOIN  ".$tblprefix."default_commission	as dc ON dc.id=tof.dc_id LEFT JOIN  ". $tblprefix."property_booking as pb ON pb.id= tof.pb_id LEFT JOIN ".$tblprefix. "cancellation as ca ON ca.id=tof.ca_id";
...
pb.id,ca.id FROM ".$tblprefix."top_offers as tof LEFT JOIN  ".$tblprefix."users
