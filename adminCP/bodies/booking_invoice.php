<?php
  ...
  $qry_booking = "SELECT
				   ...
				   ".$tblprefix."properties.short_description,
					...
					SUM(".$tblprefix."users_commission.commission) as pmc_commission,
					...
					Left Join ".$tblprefix."users_commission ON ".$tblprefix."property_booking.property_id = ".$tblprefix."users_commission.pt_id 
					Inner Join ".$tblprefix."users ON ".$tblprefix."property_booking.pm_id = ".$tblprefix."users.id 
