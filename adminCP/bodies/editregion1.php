...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="txt">
 	<tr>
  		<td id="heading">Property Region&nbsp;[Regioni]</td>
 	</tr>
...
<table cellpadding="1" cellspacing="1" border="0" >				
				<tr>
				<td class="txt1">Region Name<br/>[Naziv regiona]</td>
				<td>
				<?php
...
<div class="border_div_categories"  align="center">				
		<table cellpadding="1" cellspacing="1" border="0" >
		<tr>
		<td><input style="margin:5px; width:180px; float:none; text-align:center;" name="addsubscribeSbt" id="addsubscribeSbt" type="submit" value="Update Region&nbsp;[A&#382;uriraj region]" class="button" />
		</td>
		</tr>
		</table>
</div>
<tr>
		...
		<input type="hidden" name="act" value="editregion1">
