...
<script language="javascript">
 var imagePath='<?php MYSURL ?>graphics/';
  ...
  document.onkeypress = function hideTimePicker1 () { 
   ...
   document.onkeypress = function hideTimePicker2 () { 
    if (event.keyCode==27){
      if (!bShow){
        closeTimePicker();
      }
...
<body>
  <table>
    <tr valign=center>
      <td><input id='timepicker1' type='text' value='12:00 pm' size=8 maxlength=8 ONBLUR="validateDatePicker(this)"></td>
      <td>
	  <IMG SRC="<?php MYSURL?>graphics/timepicker.gif" BORDER="0" ALT="Pick a Time!" ONCLICK="selectTime(this,timepicker1)" STYLE="cursor:hand"/></td>
    </tr>
  </table>
  ...
  <table>
    <tr valign=center>
      <td><input id='timepicker2' type='text' value='12:00 pm' size=8 maxlength=8 ONBLUR="validateDatePicker(this)"></td>
      <td>
	  <IMG SRC="<?php MYSURL?>graphics/timepicker.gif" BORDER="0" ALT="Pick a Time!" ONCLICK="selectTime(this,timepicker2)" STYLE="cursor:hand"/></td>
    </tr>
  </table>
</body>
</html>
