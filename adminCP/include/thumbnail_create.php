...
* 
* $a = new Thumbnail('resource.jpg',150,150,'output_image.jpg',85,'"bevel()","greyscale(32,22,22)","drop_shadow(3,333333,FFFFFF)"'); 
* note: the manipulations array encased in single quotes
* 
* or the slow way
* 
* $a = new Thumbnail('resource.jpg',200,150,'output_image.jpg',85,'');
...
* (add if($this->s !== Null) to any function that needs suppressing)
* 
...
* 
* specified transformations - blank for simple resizing
* 
...
*	 'frame' plain raised border ( hex light colour, hex dark colour, int width of mid bit, hex frame colour [optional - defaults to half way between light and dark edges] )
