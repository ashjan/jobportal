...
?>
    <div id="rooms_id1">		
        <select name="room_id" class="fields" id="room_id" onChange="get_manage_bedding1('get_prop_bedding_types1',this.value,<?php echo $propid;?>,<?php echo $pm_id;?>, '<?php echo MYSURL."ajaxresponse/get_manage_bedding1.php"?>')">
        <?php
        if($count_add<=0){?>
