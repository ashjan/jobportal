...
<div id="property_id1">		
<select name="property_id" class="fields" id="property_id" onChange="get_room_pm1('rooms_id1', this.value,<?php echo $id;?>, '<?php echo MYSURL."ajaxresponse/get_rooms_image1.php"?>')">
<?php
if($count_add<=0){?>
