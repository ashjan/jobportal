...
?>
    ...
    <div id="property_id1">		
        <select name="property_id" class="fields" id="property_id" onChange="get_prop_room_minimu_stay('rooms_id1',this.value,<?php echo $id;?>, '<?php echo MYSURL."ajaxresponse/get_prop_room_minimu_stay.php"?>')">
        <?php
        if($count_add<=0){?>
