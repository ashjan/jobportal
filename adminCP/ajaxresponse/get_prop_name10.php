...
<select name="property_id" class="dropfields" id="property_id" onchange="get_room_type4('room_type', this.value, '<?php echo MYSURL."ajaxresponse/get_room_type4.php"?>','<?php echo $id; ?>')">
<?php
if($count_add<=0){?>
