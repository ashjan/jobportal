...
<div id="property_id">		
<select name="property_id" class="fields" id="property_id" onchange="get_facilities('properties_facilities', this.value, '<?php echo MYSURL."ajaxresponse/get_facilities1_1.php"?>')" >
<?php
if($count_add<=0){?>
