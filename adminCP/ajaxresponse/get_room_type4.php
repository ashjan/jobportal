...
?>
<div id="room_type">
					<!--<select name="room_type" class="dropfields" onchange="get_rates_overview1('propertyroom', this.value, '<?php //echo MYSURL."ajaxresponse/get_rates_overview1.php"?>','<?php echo $pm_id; ?>')" >-->
