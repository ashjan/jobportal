...
$id=$_GET['id'];
 $pm_id=$_GET['pm_id']; 
		...
		?>
<div id="rooms_id1">		
<select name="room_id" class="fields" id="room_id" onChange="get_rate_room1('get_rates_image1', this.value,<?php echo $id;?>,<?php echo $pm_id;?> ,'<?php echo MYSURL."ajaxresponse/get_rates_image1.php"?>')">
<?php
if($count_add<=0){?>
<option value="0">Sve sobe</option>
<?php
}else{?>
<option value="0">Izaberite sobus</option>
