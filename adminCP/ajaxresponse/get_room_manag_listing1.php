...
include($root.'include/file_include.php');
	...
	if($_SESSION[SESSNAME]['pm_moduleid']==2){
		 $module_pm_where = ' WHERE '.$tblprefix.'rooms.pm_id = '.$pm_id.' AND '.$tblprefix.'properties.pm_type=0 AND '.$tblprefix.'rooms.id = '.$room.' AND '.$tblprefix.'rooms.property_id ='.$propid;
	}else{
			...
			<?php 
			   ...
			   <?php  
						...
						$total_languages = $count_language;
			             ...
			             echo stripslashes($rs_limit->fields['room_type']); ?></td>
