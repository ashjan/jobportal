...
<div id="property_id1">		
<select name="property_id" class="fields" id="property_id" onChange="get_rooms('rooms_id1', this.value,<?php echo $id;?>, '<?php echo MYSURL."ajaxresponse/get_rooms_image.php"?>')">
<?php
if($count_add<=0){?>
