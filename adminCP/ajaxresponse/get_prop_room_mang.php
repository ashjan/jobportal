...
<div id="property_id1">		
<select name="property_id" class="fields" id="property_id" onChange="get_room_manag('rooms_id1', this.value,<?php echo $id;?>, '<?php echo MYSURL."ajaxresponse/get_rooms_manag.php"?>')">
<?php
if($count_add<=0){?>
