...
if(isset($_GET['id'])){ 
 ...
 $pm_id=$_GET['pm_id']; 
		...
		?>
<div id="rooms_id1">		
<select name="room_id" class="fields" id="room_id" onChange="get_rate_room('get_rates_image', this.value,<?php echo $id;?>,<?php echo $pm_id;?> ,'<?php echo MYSURL."ajaxresponse/get_rates_image.php"?>')">
<?php
if($count_add<=0){?>
