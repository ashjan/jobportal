...
$id=$_GET['id'];
	   ...
	   $qry_content = "SELECT * FROM  ".$tblprefix."properties WHERE pm_id=".$id." 
	   					AND ".$tblprefix."properties.pm_type=1 AND ".$tblprefix. 
						"properties.property_category=24"; 
...
?>
<div id="property_id1">		
<select name="property_id" class="fields" id="property_id" onChange="get_rates_vat_tax('get_vat_and_tax', this.value,<?php echo $id;?>, '<?php echo MYSURL."ajaxresponse/get_vat_and_tax.php"?>')">
<?php
if($count_add<=0){?>
