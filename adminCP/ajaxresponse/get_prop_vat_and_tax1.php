...
<div id="property_id1">		
<select name="property_id" class="fields" id="property_id" onChange="get_rates_vat_tax1('get_vat_and_tax1', this.value,<?php echo $id;?>, '<?php echo MYSURL."ajaxresponse/get_vat_and_tax1.php";?>')">
<?php
if($count_add<=0){?>
