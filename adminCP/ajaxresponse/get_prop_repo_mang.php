...
?>
    ...
    <div id="property_id1">		
        <select name="property_id" class="fields" id="property_id" onChange="get_report_mang('get_report_mang',this.value,<?php echo $id;?>, '<?php echo MYSURL."ajaxresponse/get_report_mang.php"?>')">
        <?php
        if($count_add<=0){?>
