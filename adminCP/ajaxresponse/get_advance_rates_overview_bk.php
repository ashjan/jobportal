...
$qry_rates = "SELECT ".$tblprefix."rooms.room_type,
					 ...
					 ".$tblprefix."standard_rates.single_adv_start_date,
					 ".$tblprefix."standard_rates.single_adv_rate_price,
					 ".$tblprefix."standard_rates.single_adv_end_date,
					 ".$tblprefix."standard_rates.advance_rate_price,
...
?></td>
	...
	$standard_start_date = $rs_rates->fields['advance_start_date'];
	$standard_end_date = $rs_rates->fields['advance_end_date'];
...
<tr>					
	...
	$values = dateValues($dates);
	if(in_array($i,$values)){
	 echo'<td class=\'txtnew\'>'.$rs_limit->fields['single_adv_rate_price'].'</td>' ;
	}else {
