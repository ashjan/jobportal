...
<div id="property_id">		
<select name="property_id" class="fields" id="property_id" onChange="get_facilities('properties_facilities', this.value, '<?php echo MYSURL."ajaxresponse/get_failities_offline.php"?>')" >
<?php
if($count_add<=0){?>
