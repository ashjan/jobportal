...
$qry_select = "SELECT * FROM ".$tblprefix."advance_date WHERE advance_date='".$date_con."' AND pm_id='".$pm_id."' AND property_id='".$property_id."' AND room_type_id='".$propertyroomid."'";
...
$qry_advance_date ="SELECT standard_date,no_of_rooms FROM ".$tblprefix."advance_date WHERE pm_id='".$pm_id."' AND room_type_id='".$property_id."'";
$rs_advance_date =$db->Execute($qry_advance_date);

$qry_tbl_cancellation = "SELECT count(id) as cancelled FROM ".$tblprefix."cancellation WHERE pm_id=".$pm_id." AND room_type_id=".$property_id."";
$rs_tbl_cancellation = $db->Execute($qry_tbl_cancellation);

$qry_advance_rooms ="SELECT advance_date,no_of_rooms FROM ".$tblprefix."advance_date WHERE pm_id=".$pm_id." AND room_type_id=".$propertyroomid;
...
<?php
 ...
 ?>				<p class="errmsg">No rates found</p>
				...
				<td><a onclick="return set_property_room_value1('newroomvalues','<?php echo MYSURL."ajaxresponse/set_property_room_value2.php"?>');">Change value</a></td>
				</tr>
				...
				<input type="hidden" name="value_month_id1" id="value_month_id1">
				</table>
				</div>
