...
?>
    <div id="rooms_id1">		
        <select name="room_id" class="fields" id="room_id" onChange="get_manage_minimu_stay('get_manage_minimu_stay',this.value,<?php echo $propid;?>,<?php echo $pm_id;?>, '<?php echo MYSURL."ajaxresponse/get_manage_minimu_stay.php"?>')">
        <?php
        if($count_add<=0){?>
