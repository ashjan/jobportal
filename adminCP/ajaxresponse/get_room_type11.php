...
?>
<div id="room_type1">
					<select name="room_type1" class="dropfields" onchange="get_room_facilities1('propertyroom', this.value, '<?php echo MYSURL."ajaxresponse/get_room_facilities1.php"?>','<?php echo $roomid; ?>')" >
