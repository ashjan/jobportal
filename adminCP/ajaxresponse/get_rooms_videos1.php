...
$id=$_GET['id'];
 $pm_id=$_GET['pm_id']; 
		...
		?>
<div id="rooms_id1">		
<select name="room_id" class="fields" id="sel_room_id" onChange="get_rates_room_videos1('get_rates_videos', this.value,<?php echo $id;?>,<?php echo $pm_id;?> ,'<?php echo MYSURL."ajaxresponse/get_rates_videos1.php"?>')">
<?php
if($count_add<=0){?>
