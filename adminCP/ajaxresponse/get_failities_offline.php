...
$query_pm = "SELECT pm_id FROM ".$tblprefix."properties WHERE id =".$propertymanagerid;
$rs_pm = $db->Execute($query_pm);
            ...
            <?php 
				...
				<tr valign="bottom" >
					...
					<?php if($_SESSION[SESSNAME]['pm_moduleid']==2){
					          $pr_id = $propertymanagerid;
						   
						   }else {
						   
						     $pr_id = base64_encode($propertymanagerid);
						   }
					?>
					...
					<input type="hidden" name="pm_id" value="<?php echo base64_encode($rs_pm->fields['pm_id']);?>">
					</td>
				</tr>
