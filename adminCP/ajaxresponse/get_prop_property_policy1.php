...
$qry_property_name = "SELECT id,property_name FROM ".$tblprefix."properties WHERE pm_type=0 AND property_category=24" ;
...
<table width="100%" border="0" cellspacing="2" cellpadding="2" class="txt">
  ...
  <tr>
    <td>
		...
		<a href="admin.php?act=manage_property_policy1&amp;mode=del_policy&amp;id=<?php echo base64_encode($rs_limit->fields['id']); ?>&amp;request_page=policy_management_1" onClick="return confirm('Jeste li sigurni da &#382;elite izbrisati?')"><img src="<?php MYSURL?>graphics/delete.gif" title="Delete" border="0" /></a>
