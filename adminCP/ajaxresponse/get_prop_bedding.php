...
?>
    ...
    <div id="property_id1">		
        <select name="property_id" class="fields" id="property_id" onChange="get_prop_bedding_types('rooms_id1',this.value,<?php echo $id;?>, '<?php echo MYSURL."ajaxresponse/get_prop_bedding_types.php"?>')">
        <?php
        if($count_add<=0){?>
