...
$property_qry = "SELECT id,property_name FROM ".$tblprefix."properties WHERE pm_id=".$_SESSION[SESSNAME]['pm_id'].' AND pm_type=1'.' AND property_category=24';
...
<div id="get_rates"> 
	 <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="txt">
			...
			<tr class="tabheading">
				...
				<td width="15%">Price Rate</td>
				<td width="15%">Single User Option</td>
				<td width="15%">Single User Rate Price</td>
				<td width="10%">Stating Date</td>
				<td width="10%">Ending Date</td>
				<td width="10%">Rooms For Sale</td>
	...
	<td colspan="11">
       <strong>Standard rates options</strong>
	</td>
	</tr>
	...
	<tr <?php if($i%2==0){ ?> bgcolor="#E7DAE7"  <?php }else{ echo 'bgcolor="#FFFFFF"'; }?>>
	<td colspan="10">
       <strong>Advance rates options 	</strong>
       <?php if($rs_limit->fields['advance_use_option']==0){?><span style="color:red">No advance option</span><?php }?>
	</td>
	<td>
	<a href="admin.php?act=edit_rates&amp;id=<?php echo base64_encode($rs_limit->fields['id']);?>">	<img src="<?php MYSURL?>graphics/edit.gif" border="0"  title="Edit" /></a>&nbsp;&nbsp;				
				<a href="admin.php?act=manage_rates&amp;mode=delete&amp;id=<?php echo base64_encode($rs_limit->fields['id']); ?>&amp;request_page=rates_management" onClick="return confirm('Are you sure you want to Delete?')"><img src="<?php MYSURL?>graphics/delete.gif" title="Delete" border="0" /></a>
	</td>
	</tr>
