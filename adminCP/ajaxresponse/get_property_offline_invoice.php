...
?>
    ...
    <div id="property_id1">		
        <select name="property_id" class="fields" id="property_id" onChange="get_offline_invoice('get_offline_invoice',this.value,<?php echo $id;?>, '<?php echo MYSURL."ajaxresponse/get_offline_invoice.php"?>')">
        <?php
        if($count_add<=0){?>
