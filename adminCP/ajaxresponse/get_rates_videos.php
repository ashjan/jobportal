...
if($_SESSION[SESSNAME]['pm_moduleid']==2){
	$module_pm_where = ' WHERE pr.pm_id = '.$_SESSION[SESSNAME]['pm_id']." AND mi.pm_id=".$_GET['pm_id']." AND mi.property_id=".$_GET['propid']." AND mi.room_id=".$_GET['id'];
}else{
 	$module_pm_where = "WHERE mi.pm_id=".$_GET['pm_id']." AND mi.property_id=".$_GET['propid']." AND mi.room_id=".$_GET['id'];
}
...
$startRow = $pageNum * $maxRows;
  $qry_faq = "SELECT mi.*,
				   ...
				   pr.property_name  
            FROM `".$tblprefix."mediaivideos` as mi 
