...
$property_name=$_GET['property_id'];
	    $qry_content = "SELECT id,property_name FROM  ".$tblprefix."properties WHERE pm_id=".$id." AND pm_type=1";
...
<select name="pr_id" class="fields" id="pr_id" onchange="get_room_type2('room_type1', this.value, '<?php echo MYSURL."ajaxresponse/get_room_type11.php"?>')">
<?php
if($count_add<=0){?>
