	...
	display:none;
			...
			<tr>
				...
				<td valign="top"><?php //echo '&nbsp;&nbsp;';echo $rs_limit->fields['profile_pic']; ?>
                                ...
                                <img border="0" width="200px" height="200px" title="Make Default" src="<?php MYSURL?>../uploads/profile_images/<?php echo $rs_limit->fields['logo']; ?>">
                                </td>
...
<tr>
						<td colspan="11">
							...
							<a href="admin.php?act=manage_employer&amp;pageNum=<?php echo max(0, $pageNum - 1)?>&amp;sortby=<?php echo $sortby; ?>" ><b>[Previous]</b></a>
							...
							if($pageNum>6)	
							{	?>
							<a id="<?php echo '0' ?>" href="admin.php?act=manage_employer&amp;pageNum=<?php echo '0';?>&amp;sortby=<?php echo $sortby; ?>&amp;condition=<?php echo base64_encode($where);?>" > <?php echo "<b>[First]</b>"; ?></a>
							&nbsp; <?php } 		
							...
							if ($i!=$pageNum){
							?>
							<a href="admin.php?act=manage_employer&amp;pageNum=<?php echo $i; ?>&amp;sortby=<?php echo $sortby; ?>"><?php echo $i+1; ?></a>
							<?php 
							}else{
							...
							<a id="<?php echo $totalPages-1 ?>" href="admin.php?act=manage_employer&amp;pageNum=<?php echo $totalPages-1;?>&amp;sortby=<?php echo $sortby; ?>&amp;condition=<?php echo base64_encode($where);?>" > <?php echo "<b>[Last]</b>"; ?></a>				    
							<?php }
							...
							?>
						 <a href="admin.php?act=manage_employer&amp;pageNum=<?php echo min($totalPages, $pageNum + 1);?>&amp;sortby=<?php echo $sortby; ?>"><b>[Next]</b> </a>
							<?php } ?>
							</div>
							</div>	
