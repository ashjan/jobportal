<?php
	...
	$qry_properties = "SELECT 
				   ...
				   INNER JOIN ".$tblprefix."property_manager_commission as pmc ON prop.id = pmc.pt_id
  ...
  <tr>
    <td >
		<table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="txt">
			...
			<tr class="tabheading">
				<td width="5%">Sr#</td>
				<td width="15%">Invoice Number<br/>[Broj fakture]</td>
                <td width="15%">Manager</td>
				<td width="15%">Property<br/>Kategorije </td>
				<td width="15%">Address<br/>Adresa</td>
				<td width="15%">Payment Due (date)<br/>Rok za plaćnje (datum)</td>
