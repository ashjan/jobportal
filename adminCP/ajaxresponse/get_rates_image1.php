...
if($_SESSION[SESSNAME]['pm_moduleid']==2){
	$module_pm_where = ' WHERE pr.pm_id = '.$_SESSION[SESSNAME]['pm_id']." AND mi.pm_id=".$_GET['pm_id']." AND mi.property_id=".$_GET['propid'].$room_id ." AND pr.pm_type=0";
	
	}else{
	$module_pm_where = "WHERE mi.pm_id=".$_GET['pm_id']." AND mi.property_id=".$_GET['propid'].$room_id." AND pr.pm_type=0";
}
			...
			?>
					<tr <?php if($i%2==0){ ?> bgcolor="#E7DAE7"  <?php }else{ echo 'bgcolor="#FFFFFF"'; }?>>
					  ...
					  ?></td>
						...
						<td valign="middle">
							<a href="admin.php?act=editmediaimages1&amp;id=<?php echo base64_encode($rs_limit->fields['id']);?>"><img src="<?php MYSURL?>graphics/edit.gif" border="0"  title="Edit" /></a>&nbsp;&nbsp;	
							<a href="admin.php?act=mediaimages1&amp;mode=delete&amp;id=<?php echo base64_encode($rs_limit->fields['id']); ?>&amp;request_page=media_upload" onClick="return confirm('Are you sure you want to Delete?')"><img src="<?php MYSURL?>graphics/delete.gif" title="Delete" border="0" /></a>
                       </td>
					</tr>
			<?php 
						$rs_limit->MoveNext();
