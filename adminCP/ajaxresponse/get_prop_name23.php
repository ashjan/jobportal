...
if($_SESSION[SESSNAME]['pm_moduleid']==2){
	$module_pm_where = ' WHERE pm_id = '.$_SESSION[SESSNAME]['pm_id'] . ' AND pm_type=1 AND property_category=24';
}else{
	$module_pm_where = 'WHERE pm_type=1 AND property_category=24';
}
...
<div id="property_id1">		
 <tr>
	...
	<?php
	/*$qry_regionsel = "SELECT * FROM ".$tblprefix."property_regions where id = '".$rs_limit->fields['town']."' " ;
	...
	<tr>
			...
			?>
				<tr>
					<!--<td colspan="14" class="errmsg"> No Data  Found</td>--><td colspan="14" class="errmsg"> Nema pronađenih podataka</td>
				</tr>
			<?php
				}// end if($totalcount > 0)
			?>
