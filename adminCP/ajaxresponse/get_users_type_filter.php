...
if($type_id != ''){
	$qry_faq = "SELECT * FROM ".$tblprefix."users WHERE user_type= ".$type_id."  ORDER BY ".$sortby." " ;
}
else {
	$qry_faq = "SELECT * FROM ".$tblprefix."users WHERE user_type != '' ORDER BY ".$sortby." " ;
	}
...
<tr>
						<td colspan="11">
							...
							if($pageNum>6)	
							{	?>
							<a id="<?php echo '0' ?>" href="admin.php?act=<?=$_GET['act']?>&amp;pageNum=<?php echo '0';?>&amp;sortby=<?php echo $sortby; ?>&amp;condition=<?php echo base64_encode($where);?>&amp;filter=enable&amp;filterid=<?php echo $type_id; ?>" > <?php echo "<b>[First]</b>"; ?></a>
							&nbsp; <?php } 		
							...
							if ($i!=$pageNum){
							?>
							<a href="admin.php?act=managepropertymanager&amp;pageNum=<?php echo $i; ?>&amp;sortby=<?php echo $sortby; ?>&amp;filter=enable&amp;filterid=<?php echo $type_id; ?>"><?php echo $i+1; ?></a>
							<?php 
							...
							<a id="<?php echo $totalPages-1 ?>" href="admin.php?act=managepropertymanager&amp;pageNum=<?php echo $totalPages-1;?>&amp;sortby=<?php echo $sortby; ?>&amp;condition=<?php echo base64_encode($where);?>"&amp;filter=enable&amp;filterid=<?php echo $type_id; ?> > <?php echo "<b>[Last]</b>"; ?></a>				    
							<?php }
							...
							?>
						 <a href="admin.php?act=managepropertymanager&amp;pageNum=<?php echo min($totalPages, $pageNum + 1);?>&amp;sortby=<?php echo $sortby; ?>&amp;filter=enable&amp;filterid=<?php echo $type_id; ?>"><b>[Next]</b> </a>
							<?php } ?>
							</div>
							</div>	
