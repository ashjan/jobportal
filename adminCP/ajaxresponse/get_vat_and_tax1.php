    ...
    <tr class="tabheading"> 
      ...
      <?php 
			 if($totalcountalpha >0){	
            	...
            	<td valign="top">
                <a href="admin.php?act=edit_vat_and_tax_charges1&amp;id=<?php echo base64_encode($rs_limit->fields['id']);?>">	<img src="<?php MYSURL?>graphics/edit.gif" border="0"  title="Edit" /></a>&nbsp;&nbsp;				
				<a href="admin.php?act=vat_and_tax_charges_management1&amp;mode=delete&amp;id=<?php echo base64_encode($rs_limit->fields['id']); ?>&amp;request_page=manage_vat_and_tax_charges1" onClick="return confirm('Are you sure you want to Delete?')"><img src="<?php MYSURL?>graphics/delete.gif" title="Delete" border="0" /></a>
                        </td>
            </tr>
            <?php 
			$rs_limit->MoveNext();
