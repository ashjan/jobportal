...
?>
<div id="room_type">
	<select name="room_type" class="dropfields" onchange="get_room_facilities1('propertyroom', this.value, '<?php echo MYSURL."ajaxresponse/get_room_facilities1.php"?>','<?php echo $roomid; ?>')" >
