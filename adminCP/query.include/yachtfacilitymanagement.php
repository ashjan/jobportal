...
if($error!=''){
			...
			header("Location: admin.php?errmsg=$msg&act=".$post['act']);
					...
					echo	 $update_img_query = "INSERT ".$tblprefix."yacht_facility 
						                                SET
...
if($_POST['mode']=='update_room_ameneties' && $_POST['act']=='edityachtfacility' && $_POST['request_page']=='yatchfacilitymanagement'){
echo "test";
exit();
...
echo	$update_img_query = "UPDATE ".$tblprefix."yacht_facility 
						                                SET
	...
	if($_POST['mode']=='update_media_n_tech' && $_POST['act']=='edityachtfacility' && $_POST['request_page']=='yatchfacilitymanagement'){
echo "test";
exit();
$post=$_POST;
$error='';
...
echo	$update_img_query = "UPDATE ".$tblprefix."yacht_facility 
 ...
 if($_POST['mode']=='food_n_drinks' && $_POST['act']=='edityachtfacility' && $_POST['request_page']=='yachtfacilitymanagement'){
echo "test";
exit();
$post=$_POST;
$error='';
...
echo	$update_img_query = "UPDATE ".$tblprefix."yacht_facility 
 ...
 if($_POST['mode']=='update_bathroom' && $_POST['act']=='edityachtfacility' && $_POST['request_page']=='yachtfacilitymanagement'){
 echo "test";
exit();
$post=$_POST;
$error='';
...
if($_POST['mode']=='update' && $_POST['act']=='edityachtfacility' && $_POST['request_page']=='yachtfacilitymanagement'){
...
if($_GET['mode']=='delete' && $_GET['act']=='yachtfacility' && $_GET['request_page']=='yachtfacilitymanagement'){
...
//---------Status Code---------		
if($_GET['mode']=='change_default' && $_GET['act']=='yachtfacility' && $_GET['request_page']=='yachtfacilitymanagement'){
