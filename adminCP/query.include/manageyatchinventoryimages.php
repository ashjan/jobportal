<?php 
// image media add
if($_POST['mode']=='add' && $_POST['act']=='yatchinventoryimages' && $_POST['request_page']=='manageyatchinventoryimages'){
$post=$_POST;
$error='';
...
if($_POST['mode']=='update' && $_POST['act']=='edityatchinventoryimages' && $_POST['request_page']=='manageyatchinventoryimages'){
...
if($_GET['mode']=='delete' && $_GET['act']=='yatchinventoryimages' && $_GET['request_page']=='manageyatchinventoryimages'){
