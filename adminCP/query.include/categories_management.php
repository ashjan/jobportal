...
//---------Add Category---------
	...
	if($_POST['mode']=='add' && $_POST['act']=='managecategories' && $_POST['request_page']=='categories_management'){
		...
		$slug=slugcreation($categoryname);
			...
			if($categoryname == ''){
				...
				echo $sql_category= "INSERT INTO ".$tblprefix."thirdlevel_content_category 
														SET
...
//---------Edit Category---------
	...
	if($_POST['mode']=='update' && $_POST['act']=='managecategories' && $_POST['request_page']=='categories_management'){
	echo "  WE are here ";
...
######################
	...
	if($_GET['mode']=='change_default' && $_GET['act']=='manage_language' && $_GET['request_page']=='categories_management'){
...
if($_GET['mode']=='del_category' && $_GET['act']=='managecategories' && $_GET['request_page']=='categories_management'){
		$id=base64_decode($_GET['id']);

		$del_qry = " DELETE FROM ".$tblprefix."thirdlevel_content_category WHERE id = ".$id." or parent_id=".$id;
		...
		$okmsg = base64_encode("Category Deleted successfully. !");
					header("Location: admin.php?okmsg=$okmsg&act=managecategories");
					exit;	  
} 
