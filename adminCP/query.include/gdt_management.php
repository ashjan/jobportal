<?php
if($_POST['mode']=='add' && $_POST['act']=='manage_gdt' && $_POST['request_page']=='gdt_management'){
...
$gdt_page_title_slug=preg_replace('/[^a-z0-9]/i', '', $gdt_page_title_slug);
	...
	echo "helo";
					echo  $insert_gdt_query  =  "INSERT INTO ".$tblprefix."site_gdt SET 
...
if($_POST['mode']=='update' && $_POST['act']=='manage_gdt' && $_POST['request_page']=='gdt_management')
{
...
$gdt_page_title_slug=preg_replace('/[^a-z0-9]/i', '', $gdt_page_title_slug);
		...
		if($error!=''){
					...
					header("Location: admin.php?okmsg=$msg&act=".$post['act']);
				 	...
				 	$update_gdt_query  =  "UPDATE ".$tblprefix."site_gdt SET 
																gdt_page_title = '".$gdt_page_title."',
																gdt_description = '".$gdt_description."',
																gdt_flag = '".$gdt_flag."',
																gdt_slug = '".$gdt_page_title_slug."'
...
if($_GET['mode']=='delete' && $_GET['act']=='manage_gdt' && $_GET['request_page']=='gdt_management')
{
 	...
 	$id=base64_decode($_GET['id']); 
		...
		$del_qry = " DELETE FROM ".$tblprefix."site_gdt WHERE id =".$id;  
