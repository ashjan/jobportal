...
if($_POST['mode']=='add' && $_POST['act']=='room_facility_management1' && $_POST['request_page']=='manage_room_facility1'){
	$post=$_POST;
	$error='';
...
if($_POST['mode']=='delete_room_ameneties1' && $_POST['act']=='room_facility_management1' && $_POST['request_page']=='manage_room_facility1'){
...
if($_POST['mode']=='delete_media_n_tech1' && $_POST['act']=='room_facility_management1' && $_POST['request_page']=='manage_room_facility1'){
...
if($_POST['mode']=='delete_food_n_drinks1' && $_POST['act']=='room_facility_management1' && $_POST['request_page']=='manage_room_facility1'){
...
if($_POST['mode']=='delete_bathroom1' && $_POST['act']=='room_facility_management1' && $_POST['request_page']=='manage_room_facility1'){
	$post=$_POST;
	$error='';
	if($_POST['first_name']==0){
		$error = "Please select PM";
...
if($_POST['mode']=='update' && $_POST['act']=='room_facility_management1' && $_POST['request_page']=='manage_room_facility1'){
...
if($_GET['mode']=='delete' && $_GET['act']=='room_facility_management1' && $_GET['request_page']=='manage_room_facility1'){
...
//---------Status Code---------
if($_GET['mode']=='change_default' && $_GET['act']=='room_facility_management1' && $_GET['request_page']=='manage_room_facility1'){
