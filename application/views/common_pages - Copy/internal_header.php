...
<!--   <script type="text/javascript" src="<?php echo base_url() . 'resources/js/jquery.autocomplete.min.js'; ?>"></script>-->
     ...
     <script type="text/javascript" src='http://192.168.162.244:2065/cisco/application/views/fancybox/lib/jquery.mousewheel-3.0.6.pack.js'></script>
    <script type="text/javascript" src='http://192.168.162.244:2065/cisco/application/views/fancybox/source/jquery.fancybox.js?v=2.1.5'></script>
    <link href="http://192.168.162.244:2065/cisco/application/views/fancybox/source/jquery.fancybox.css?v=2.1.5" rel="stylesheet" type="text/css" />
