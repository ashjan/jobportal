...
?>
            ...
            <?php echo form_open('resume/edit_work/'.$res_id.'/'.$id);?>
            ...
            <h3>Work History</h3>
                ...
                <div class="field"><input type="hidden" id="indexi" value="0"/><input type="text" class="inpt_fld" name="desig" id="desig" required="" value="<?php if(!empty($work)){ echo $work[0]['designation'];}elseif($this->input->post('desig') != ""){ echo $this->input->post('desig'); }?>"/></div>
                <div class="clearfix"></div>
                
                <div class="text">Company:</div>
                <div class="field"><input type="hidden" name="id" value="<?php echo $id;?>"/><input type="text" class="inpt_fld" name="cmpny" id="cmpny" required="" value="<?php if(!empty($work)){ echo $work[0]['company_name'];}elseif($this->input->post('cmpny') != ""){ echo $this->input->post('cmpny'); }?>"/></div>
                <div class="clearfix"></div>
                ...
                <div class="field"><input type="hidden" name="res_id" value="<?php echo $res_id;?>"/><input class="inpt_fld" type="text" name="strt_date" id="strt_date" required="" value="<?php if(!empty($work)){ echo $work[0]['start_date'];}elseif($this->input->post('start_date') != ""){ echo $this->input->post('start_date'); }?>"/></div>
                <div class="clearfix"></div>
                
                <div class="text">End Date:</div>
                <div class="field"><input class="inpt_fld" type="text" name="end_date" id="end_date" value="<?php if(!empty($work)){ echo $work[0]['end_date'];}elseif($this->input->post('end_date') != ""){ echo $this->input->post('end_date'); }?>"/></div>
                <div class="clearfix"></div>
                
                <div class="text">Job Responsibilities:</div>
                <div class="field"><textarea name="responsiblty" id="responsiblty"><?php if(!empty($work)){ echo stripslashes($work[0]['job_responsibilities']);}elseif($this->input->post('responsiblty') != ""){ echo $this->input->post('responsiblty'); }?></textarea></div>
                <div class="clearfix"></div>
...
function add_more()
    {
        ...
        var strt = "";
        strt += '<div class="text">Start Date:</div><div class="field"><input style="width: 250px;" type="text" name="strt_date[]" id="strt_date_'+ indexo +'" required=""/></div><div class="clearfix"></div>';
         strt += '<div class="text">End Date:</div><div class="field"><input style="width: 250px;" type="text" name="end_date[]" id="end_date_'+ indexo +'" required=""/></div><div class="clearfix"></div>';
    ...
    function add_more_achiev()
    {
        ...
        var strt = "";
        strt += '<div class="text">Date:</div><div class="field"><input style="width: 250px;" type="text" name="ach_date[]" id="ach_date'+ indexo +'" required=""/></div><div class="clearfix"></div>';
