...
<body>
	...
	<div class="right_panel">
            ...
            <div class="form_container">
                ...
                <div class="field"><select id="Country" name="Country" class="inpt_fld">
                ...
                <div class="field"><select id="State" name="State" class="inpt_fld">
                ...
                <div class="field"><input id="searchTextField" type="text" name="adress"  size="50" class="inpt_fld" value="<?php if($profile[0]['address'] != ""){ echo $profile[0]['address'];}?>" style="text-align: left;width:357px;direction: ltr;"></div>
<div class="clearfix"></div>

           <div class="text">latitude:</div>
           <div class="field"><input name="latitude" class="MapLat inpt_fld"  type="text" placeholder="Latitude" style="width: 161px;" value="<?php if($profile[0]['latitude'] != ""){ echo $profile[0]['latitude'];}?>" readonly=""/></div>
            <div class="clearfix"></div>
            
            <div class="text">longitude:</div>
            <div class="field"><input name="longitude" class="MapLon inpt_fld" type="text" placeholder="Longitude" style="width: 161px;" value="<?php if($profile[0]['longitude'] != ""){ echo $profile[0]['longitude'];}?>" readonly=""/></div>
            <div class="clearfix"></div>
...
<script>
    ...
    upload_url = '<?php echo base_url() . 'profile/dyn_logo_upload'; ?>';
    link_redirect = '<?php echo base_url() . 'profile/comp_profile_editor'; ?>';
// Add events
...
//                alert(data);
    ...
    state_id = '<?php echo $profile[0]['state'];?>';
    city_id = '<?php echo $profile[0]['city'];?>';
