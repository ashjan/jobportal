...
<!--                <div class="text">Address 2:</div>
                ...
                <div class="del_adeed"><a href="<?php echo base_url().'resume/delete_edu/'.$resume_details[0]['id'].'/'.$res['id'];?>"> <img src="<?php echo base_url().'resources/images/delete_edit_icon.png'?>"/> </a></div>
    ...
    $('#end_date'+inc).Zebra_DatePicker();
                ...
                <div id="experiances">
                    ...
                    <?php if(!empty($resume_details) && !empty($resume_details[0]['work_details'])){
                ...
                <div class="del_adeed"><a href="<?php echo base_url().'resume/delete_work/'.$resume_details[0]['id'].'/'.$wrk['id'];?>"> <img src="<?php echo base_url().'resources/images/delete_edit_icon.png'?>"/> </a></div>
                ...
                <div class="del_adeed"><a href="<?php echo base_url().'resume/delete_train/'.$resume_details[0]['id'].'/'.$tran['id'];?>"> <img src="<?php echo base_url().'resources/images/delete_edit_icon.png'?>"/> </a></div>
                    <script>
                     var inc = <?php echo $incr;?>;
                ...
                <div class="del_adeed"><a href="<?php echo base_url().'resume/delete_achiev/'.$resume_details[0]['id'].'/'.$ach['id'];?>"> <img src="<?php echo base_url().'resources/images/delete_edit_icon.png'?>"/> </a></div>
