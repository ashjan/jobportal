...
<body>
	...
	<div class="right_panel_login reg_pnl">
            ...
            echo validation_errors();?></div>
                ...
                <div class="field"><input type="text" class="inpt_fld" name="email" id="email" required value="<?php if($this->input->post('email') != ""){ echo $this->input->post('email');}?>" onBlur="javascript:check_email(this);"/> <span id="email_avl_stat"></span> </div> 
                <div class="clearfix"></div>
            ...
            <div class="text">Town:</div>
                ...
                <div class="text"></div>
                <div class="field"><input type="submit" id="submit_btnn" name="submit" value="Register"/></div>
                <div class="clearfix"></div>
    ...
    function check_email(ele)
    {
        ...
        $.ajax({url:emailcheck,type:"POST",data:form_data,success:function(result){
                if(result == 'Available'){
                    ...
                    eml_txt = '<font color="red"> Not Available </font>';
                    document.getElementById("submit_btnn").disabled = true;
                }
                $('#email_avl_stat').html(eml_txt);
        }});
    }
