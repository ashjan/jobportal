	...
	<div class="right_panel">
            ...
            echo validation_errors();?></div>
             ...
             <h3>Courses/Trainings/Workshops</h3>
                ...
                <div id="trainings" style="display:block;">
            ...
            <h3>Business Skills</h3>
                ...
                <div class="text"></div>
                <div class="field"><input type="submit" name="submit" value="Save"/> <a class="skp_bt" href="<?php echo base_url();?>resume/resume_details/<?php echo $id;?>"><input class="skp_btn" type="button" name="skip" value="Skip This Step"/></a></div>
                <div class="clearfix"></div>
