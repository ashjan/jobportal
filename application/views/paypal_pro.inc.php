...
class paypal_pro
{
	...
	function __construct($API_USERNAME, $API_PASSWORD, $API_SIGNATURE, $PROXY_HOST, $PROXY_PORT, $IS_ONLINE = FALSE, $USE_PROXY = TRUE, $VERSION = '57.0')
	{
	...
	function hash_call($methodName,$nvpStr)
	{
		...
		curl_setopt($ch, CURLOPT_PROXY, '192.168.115.22:3128');
		/*if($this->USE_PROXY)
		{
