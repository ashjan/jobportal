...
?>
            ...
            <?php echo form_open('resume/edit_achiev/'.$res_id.'/'.$id);?>
            ...
            <h3>Key Achievements</h3>
                ...
                <div class="field"><input type="hidden" value="<?php echo $id;?>" name="id"/><input type="text" class="inpt_fld" name="desc" id="desc" value="<?php if(!empty($achievement)){ echo $achievement[0]['description'];}elseif($this->input->post('desc') != ""){ echo $this->input->post('desc');}?>"/></div>
                <div class="clearfix"></div>
                
                <div class="text">Location:</div>
                <div class="field"><input type="hidden" value="<?php echo $res_id;?>" name="res_id"/><input type="text" class="inpt_fld" name="location" id="location" value="<?php if(!empty($achievement)){ echo $achievement[0]['location'];}elseif($this->input->post('location') != ""){ echo $this->input->post('location');}?>"/></div>
                <div class="clearfix"></div>
                
                </div>
                
                <div class="text">Date:</div>
                <div class="field"><input class="inpt_fld" type="text" name="ach_date" id="ach_date" value="<?php if(!empty($achievement)){ echo $achievement[0]['ach_date'];}elseif($this->input->post('ach_date') != ""){ echo $this->input->post('ach_date');}?>"/></div>
                <div class="clearfix"></div>
