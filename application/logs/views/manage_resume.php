...
<body>
	...
	<div class="right_panel">
            ...
            echo validation_errors();?></div>
                ...
                <div class="field"><input type="file" class="inpt_fld" name="userfile1" required="required" /></div>
                <div class="clearfix"></div>
            ...
            <h3>Personal details</h3>
                ...
                <div class="field"><input type="text" class="inpt_fld" name="lname" id="lname" required="" value="<?php if($this->input->post('lname') != ""){ echo $this->input->post('lname'); }?>"/></div>
                <div class="clearfix"></div>
                ...
                <div class="field"><input type="text" class="inpt_fld" name="cnic" id="cnic" value="<?php if($this->input->post('lname') != ""){ echo $this->input->post('lname'); }?>"/></div>
                <div class="clearfix"></div>
...
<!--                <div class="text">Address 2:</div>
                <div class="field"><input type="text" class="inpt_fld" name="adres2" id="adres2" value="<?php if($this->input->post('adres') != ""){ echo $this->input->post('adres'); }?>"/></div>
                <div class="clearfix"></div>-->
