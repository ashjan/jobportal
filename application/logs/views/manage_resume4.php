...
<body>
	...
	<div class="right_panel">
            ...
            <h3>Key Achievements</h3>
                ...
                <div class="text"></div>
                <div class="field"><input type="submit" name="submit" value="Save"/> <a class="skp_bt" href="<?php echo base_url();?>index.php/resume/step_five/<?php echo $id;?>"><input class="skp_btn" type="button" name="skip" value="Skip This Step"/></a></div>
                <div class="clearfix"></div>
