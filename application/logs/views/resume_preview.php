    ...
    <?php 
        ...
        ?>
           <?php //echo "<pre>"; print_r($reseme_details); exit; ?>
            ...
            <div class="ttl"><strong class="gen_inf">Phone #: </strong> <?php echo $reseme_details[0]['phone']; ?></div>
            
            
            <?php if($reseme_details[0]['cnic']){?>
            <div class="ttl"><strong>CNIC #: </strong> <?php echo $reseme_details[0]['cnic']; ?>  </div>
            
            <?php } ?>
            
            <?php if($reseme_details[0]['salary']){?>
            <div class="ttl"><strong>Current Salary: </strong> <?php echo $reseme_details[0]['salary']; ?> </div> 
            
            <?php } ?>
            
            <?php if($reseme_details[0]['expected_salary']){?>
            <div class="ttl"><strong>Expected Salary: </strong> <?php echo $reseme_details[0]['expected_salary']; ?>  </div>
            
            <?php } if($reseme_details[0]['email'] != ""){?>
            
            <div class="ttl"><strong>Email: </strong> <?php echo $reseme_details[0]['email']; ?>  </div>
            
            <?php } if($reseme_details[0]['date_of_birth'] != ""){?>
            <div class="ttl"><strong>Date Of Birth: </strong> <?php echo date("l jS F Y",strtotime($reseme_details[0]['date_of_birth'])); ?> </div> 
            
            <?php } if($reseme_details[0]['available_date'] != ""){?>
            <div class="ttl"><strong>Available From: </strong> <?php echo date("l jS F Y",strtotime($reseme_details[0]['available_date'])); ?> </div> 
            <div class="clearfix"></div>
            <?php } ?>
...
?>
            ...
            <?php } ?>
                ...
                <?php if(!empty($reseme_details[0]['education_details'])){?>
...
?>
            ...
            <?php if(!empty($reseme_details[0]['work_details'])){?>
...
?>
            ...
            <?php if(!empty($reseme_details[0]['trainings'])){?>
...
?>
            ...
            <?php if(!empty($reseme_details[0]['achievements'])){?>
