			...
			<div id="LatestCompanies"> Hot Companies </div>
                        ...
                        <div class="latest_job">
                            ...
                            <div class="comp_name"> <?php echo $ltst['first_name']." ".$ltst['last_name'];?> </div>
                                ...
                                <div class="loc_icon"> <a href="<?php echo base_url().'index.php/jobs/load_map';?>"><img height="25px" src="<?php echo base_url();?>resources/images/images/Layer40copy4.png"></a> </div>
