...
<!--		<div id="Shape4"><img src="<?php //echo base_url();?>resources/images/images/Shape4.png"></div> -->
		    <div id="latest_container">
                        ...
                        <div id="tabs1" class="" onclick="javascript:aply_active('tabs1');">
			...
			<div id="LatestCompanies"> Hot Companies </div>
                        ...
                        <div class="latest_job">
                            ...
                            <div class="comp_name"> <?php echo $ltst['first_name']." ".$ltst['last_name'];?> </div>
                                ...
                                <div class="loc_icon"> <input type="hidden" value="Software Technology Park, Service Rd N, Islamabad, Pakistan" name="adrs_<?php echo $ini;?>" id="adrs_<?php echo $ini;?>"/> <a href="<?php echo base_url().'index.php/welcome/load_map/';?>"> <img height="25px" src="<?php echo base_url();?>resources/images/images/Layer40copy4.png"> </a> </div>
    ...
    <a style="color: #0e886d; font-family: Arial;font-weight: normal;text-align: center;font-size: 20px; text-decoration:none;" href="<?php echo base_url().'index.php/welcome/job_listing'?>">
        See More</a></div>              
                            <?php } ?>
                             </div>
                        ...
                        <div class="latest_resume">
                            ...
                            <div class="loc_icon"> <a href="<?php echo base_url().'index.php/welcome/load_map';?>"> <img height="25px" src="<?php echo base_url();?>resources/images/images/Layer40copy4.png"> </a> </div>
                            <div class="location"> <?php echo $ltst['city_name'];?> </div>
...
<!--                                <img src="<?php echo base_url();?>resources/images/images/part_time.png"/>-->
                            ...
                            if($res_count == 7){?>
                            <div class="see_mre">
<a href="<?php echo base_url().'index.php/welcome/cand_list';?>">
    See More</a></div>
                            <?php } ?>
                             </div>
...
<!--                                <img src="<?php echo base_url();?>resources/images/images/part_time.png"/>-->
                            ...
                            ?>
                            <div class="see_mre">
<a href="<?php echo base_url().'index.php/welcome/companies_listing';?>">See More</a></div>	
                            <?php } ?>
                             </div>
...
<!--			<div id="MUG"><img src="<?php echo base_url();?>resources/images/images/MUG.png"></div>-->
                            ...
                            var map_url = "<?php echo base_url().'index.php/welcome/load_map';?>";
