	...
	public function index()
	{
            ...
            if($this->form_validation->run() == FALSE)
            {
                ...
                if($result > 0)
                {
                    ...
                    $this->session->set_flashdata('msg','Resume adding error.');
...
//						exit;
						...
						{
							echo move_uploaded_file($tempFile,$targetFile); exit;
							$this->db->query("
											INSERT 
											INTO
		...
		//echo "<div class='img'><img src='".base_url()."upload/".$img."'/></div>";
            ...
            {
                $this->session->set_flashdata('msg','Image uploading error...!');
        ...
        public function step_five()
        {
            ...
            else 
            {
               ...
               $result = $this->resume_model->add_skill_info($ttl, $b_skil, $l_skil, $c_skil, $ref, $id, $cand_id);
                ...
                {
                    $this->session->set_flashdata('msg','your skills Posting error...!');
                    redirect('resume/step_five/'.$id);
                    exit;
                }
            }
        ...
        function resume_upload()
        {
            ...
            if($add_resume > 0)
            {
                ...
                $this->session->set_flashdata('msg','your resume Uploading Error...!');
           ...
           if($result > 0)
                {
                    ...
                    $this->session->set_flashdata('msg','Resume updating error.');
                    redirect('resume/edit_resume/'.$id.'/'.$cand_id);
                    exit;
                }
       }
       ...
       else
       {
           $cand_id = $this->uri->segment(5);
            ...
            public function delete_edu()
            {
                ...
                {
                    $this->session->set_flashdata('msg','education Detail deletion error...!');
                    redirect('resume/edit_resume/'.$resume_id);
                    exit;
                }
            }
    ...
    public function edit_resume6()
    {
       ...
       $des= $this->input->post('desc');
            ...
            else 
            {
                ...
                {
                    $this->session->set_flashdata('msg','your achievements Posting error...!');
                    redirect('resume/edit_resume/'.$id);
                    exit;
                }
            }
    ...
    public function edit_work()
    {
       ...
       $this->form_validation->set_rules('desig','Designation','required');
            ...
            else 
            {
                ...
                {
                    $this->session->set_flashdata('msg','your Work editing error...!');
                    redirect('resume/edit_resume/'.$res_id[0]);
                    exit;
                }
            }
            ...
            public function delete_work()
            {
                ...
                {
                    $this->session->set_flashdata('msg','Work Detail deletion error...!');
                    redirect('resume/edit_resume/'.$resume_id);
                    exit;
                }
            }
    ...
    public function edit_achiev()
    {
       ...
       $this->form_validation->set_rules('desc','Description','required');
            ...
            else 
            {
                ...
                {
                    $this->session->set_flashdata('msg','your Achievements editing error...!');
                    redirect('resume/edit_resume/'.$res_id[0]);
                    exit;
                }
            }
            ...
            public function delete_achiev()
            {
                ...
                {
                    $this->session->set_flashdata('msg','Achievement Detail deletion error...!');
                    redirect('resume/edit_resume/'.$resume_id);
                    exit;
                }
            }
       ...
       public function edit_resume5()
        {
            ...
            else 
            {
                ...
                {
                    $this->session->set_flashdata('msg','your Training Posting error...!');
                    redirect('resume/edit_resume/'.$id);
                    exit;
                }
            }
        ...
        public function edit_train()
        {
            ...
            else 
            {
                ...
                {
                    $this->session->set_flashdata('msg','your Training Editing error...!');
                    redirect('resume/edit_resume/'.$res_id[0]);
                    exit;
                }
            }
            ...
            public function fav_cand_listing()
            {
                ...
                $this->data['cands'] = $this->resume_model->get_fav_candidates($page, $config['per_page'], $emp_id);
